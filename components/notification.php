<div class="main_notification_container position-relative">
    <div class="bell d-flex gap-2 align-items-center" title="Notification">
    ...
    <div class="notifcationpopup_content">
        <div class="notification_heading d-flex align-items-center gap-3 justify-content-between w-100 px-2 mb-3">
            <h4>Notifications</h4>
            <div class="noti_num">
                (4)
            </div>
        ...
        <div class="notification_list_container px-2">
            <div class="notificatioin_detail d-flex gap-3">
                <div class="profile">
                    <img src="assets/images/profileimg.jpg" alt="profile image">
                </div>

                <div class="not_desc">
                    <p>HRM: New employee onboarding session at 10 AM.</p>
