        ...
        <div class="admin_list_heading d-flex align-items-center flex-wrap gap-3 justify-content-between outer_padding">
            ...
            <div class="right_fil_div d-flex align-items-center gap-2 flex-wrap justify-content-md-end">
                ...
                <button class="add_acc_group add_acc_groupBtn"
                    data-heading="Add Account Group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table_actions">
                                            <a href="#" title="View Details" class="add_acc_groupBtn" data-heading="View Account Group">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            ...
                                            <a href="#" aria-label="Edit Labout List" title="Edit Labour List" class="add_acc_groupBtn"
                                                data-heading="Edit Account Group">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
...
<!-- Add Account Group (inner) pop up  -->
    ...
    <div class="outer_layout">
        <div class="change_ledger_group_popup_content">
            <div class="monthly_heading pe-4">
                Change ledger to another account group
            ...
            <div class="attendance_form mt-4">
                <h4>Change ledger to another account group </h4>
                <p>Please kindly complete the form</p>
                <div class="common_form">
                    <form action="">
                        <div class="row g-3 align-items-end">
