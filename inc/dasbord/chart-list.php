 <div class="top_chart_container">
     ...
     <div class="card first_card">
         <div class="d-flex align-items-center gap-3 justify-content-between">
             <div class="card_div">
                 <p class="card-title"><?= $chartData['cashTitle'] ?? 'Total Projects' ?></p>
                 <span><?= $chartData['cashsubTitle'] ?? 'Your Total Project is' ?></span>
             </div>
             <div class="d-flex align-items-center gap-2">
                 <h4 class="card-value"><?= $chartData['cashValue'] ?? '1000' ?></h4>
     ...
     <div class="card second_payment">
         <div class="d-flex align-items-center justify-content-between gap-2">
             <div>
                 <p class="card-title"><?= $chartData['bankTitle'] ?? 'Total Income' ?></p>
                 <h2 class="card-value"><?= $chartData['bankValue'] ?? '3,56,792.230' ?> Dr</h2>
             </div>
     ...
     <div class="card payment_card">
         <div class="d-flex align-items-center justify-content-between gap-2">
             <div>
                 <p class="card-title"><?= $chartData['paymentTitle'] ?? 'Total Expenditure' ?></p>
                 <h2 class="card-value">Rs <?= $chartData['paymentValue'] ?? '20,000' ?></h2>
             </div>
         ...
         <div class="payment_small_title d-flex align-items-center gap-2 justify-content-between flex-wrap">
             <small class="card-subtitle"><?= $chartData['paymentsubTitle'] ?? '' ?></small>
             <div>
                 20/28
             </div>
         </div>
