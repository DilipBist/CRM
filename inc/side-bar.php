                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <a href="#" class="menu-item accordion-button <?php echo ($currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '') ? '' : 'collapsed'; ?>" data-bs-toggle="collapse" data-bs-target="#menu-collapse-vehicle" aria-expanded="<?php echo ($currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === ' ' || $currentPage === '' || $currentPage === '' || $currentPage === '') ? 'true' : 'false'; ?>"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                        <path d="M10.5 2.19V8.4225C10.5 9.1875 9.8775 9.81 9.1125 9.81H2.25C1.8375 9.81 1.5 9.4725 1.5 9.06V4.2675C1.5 2.7375 2.7375 1.5 4.2675 1.5H9.8025C10.1925 1.5 10.5 1.8075 10.5 2.19Z" fill="#FFF" />
                                        <path d="M16.125 11.625C16.335 11.625 16.5 11.79 16.5 12V12.75C16.5 13.995 15.495 15 14.25 15C14.25 13.7625 13.2375 12.75 12 12.75C10.7625 12.75 9.75 13.7625 9.75 15H8.25C8.25 13.7625 7.2375 12.75 6 12.75C4.7625 12.75 3.75 13.7625 3.75 15C2.505 15 1.5 13.995 1.5 12.75V11.25C1.5 10.8375 1.8375 10.5 2.25 10.5H9.375C10.41 10.5 11.25 9.66 11.25 8.625V4.5C11.25 4.0875 11.5875 3.75 12 3.75H12.63C13.17 3.75 13.665 4.0425 13.935 4.5075L14.415 5.3475C14.4825 5.4675 14.3925 5.625 14.25 5.625C13.215 5.625 12.375 6.465 12.375 7.5V9.75C12.375 10.785 13.215 11.625 14.25 11.625H16.125Z" fill="#FFF" />
                                        <path d="M6 16.5C6.82843 16.5 7.5 15.8284 7.5 15C7.5 14.1716 6.82843 13.5 6 13.5C5.17157 13.5 4.5 14.1716 4.5 15C4.5 15.8284 5.17157 16.5 6 16.5Z" fill="#FFF" />
                                        <path d="M12 16.5C12.8284 16.5 13.5 15.8284 13.5 15C13.5 14.1716 12.8284 13.5 12 13.5C11.1716 13.5 10.5 14.1716 10.5 15C10.5 15.8284 11.1716 16.5 12 16.5Z" fill="#fff" />
                                        <path d="M16.5 9.3975V10.5H14.25C13.8375 10.5 13.5 10.1625 13.5 9.75V7.5C13.5 7.0875 13.8375 6.75 14.25 6.75H15.2175L16.305 8.655C16.4325 8.88 16.5 9.135 16.5 9.3975Z" fill="#FFF" />
                                    </svg>
                                    Vehicle
                                </a>
                            </h2>
                            <div id="menu-collapse-vehicle" class="accordion-collapse collapse <?php echo ($currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '' || $currentPage === '') ? 'show' : ''; ?>"
                                ...
                                <div class="accordion-body">
                                    <a href="#" class="menu-item  <?php echo ($currentPage === '') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path d="M16.3125 6.0025C16.3125 6.31 16.0575 6.565 15.75 6.565H2.25C1.9425 6.565 1.6875 6.31 1.6875 6.0025C1.6875 5.695 1.9425 5.44 2.25 5.44H3.015L3.3 4.0825C3.57 2.77 4.1325 1.5625 6.3675 1.5625H11.6325C13.8675 1.5625 14.43 2.77 14.7 4.0825L14.985 5.44H15.75C16.0575 5.44 16.3125 5.695 16.3125 6.0025Z" fill="#FFF" />
                                            <path d="M16.6342 10.245C16.5217 9.0075 16.1917 7.6875 13.7842 7.6875H4.21421C1.80671 7.6875 1.48421 9.0075 1.36421 10.245L0.94421 14.8125C0.89171 15.3825 1.07921 15.9525 1.46921 16.38C1.86671 16.815 2.42921 17.0625 3.02921 17.0625H4.43921C5.65421 17.0625 5.88671 16.365 6.03671 15.9075L6.18671 15.4575C6.35921 14.94 6.40421 14.8125 7.07921 14.8125H10.9192C11.5942 14.8125 11.6167 14.8875 11.8117 15.4575L11.9617 15.9075C12.1117 16.365 12.3442 17.0625 13.5592 17.0625H14.9692C15.5617 17.0625 16.1317 16.815 16.5292 16.38C16.9192 15.9525 17.1067 15.3825 17.0542 14.8125L16.6342 10.245ZM6.74921 11.8125H4.49921C4.19171 11.8125 3.93671 11.5575 3.93671 11.25C3.93671 10.9425 4.19171 10.6875 4.49921 10.6875H6.74921C7.05671 10.6875 7.31171 10.9425 7.31171 11.25C7.31171 11.5575 7.05671 11.8125 6.74921 11.8125ZM13.4992 11.8125H11.2492C10.9417 11.8125 10.6867 11.5575 10.6867 11.25C10.6867 10.9425 10.9417 10.6875 11.2492 10.6875H13.4992C13.8067 10.6875 14.0617 10.9425 14.0617 11.25C14.0617 11.5575 13.8067 11.8125 13.4992 11.8125Z" fill="#FFF" />
                                        </svg>
                                        Vehicle List
                                    </a>
                                    <a href="#" class="menu-item  <?php echo ($currentPage === '') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path d="M14.632 4.3875L10.177 1.815C9.44945 1.395 8.54945 1.395 7.81445 1.815L3.36695 4.3875C2.63945 4.8075 2.18945 5.5875 2.18945 6.435V11.565C2.18945 12.405 2.63945 13.185 3.36695 13.6125L7.82195 16.185C8.54945 16.605 9.44945 16.605 10.1845 16.185L14.6395 13.6125C15.367 13.1925 15.817 12.4125 15.817 11.565V6.435C15.8095 5.5875 15.3595 4.815 14.632 4.3875ZM8.99945 5.505C9.96695 5.505 10.747 6.285 10.747 7.2525C10.747 8.22 9.96695 9 8.99945 9C8.03195 9 7.25195 8.22 7.25195 7.2525C7.25195 6.2925 8.03195 5.505 8.99945 5.505ZM11.0095 12.495H6.98945C6.38195 12.495 6.02945 11.82 6.36695 11.3175C6.87695 10.56 7.86695 10.05 8.99945 10.05C10.132 10.05 11.122 10.56 11.632 11.3175C11.9695 11.8125 11.6095 12.495 11.0095 12.495Z" fill="#EBEBEB" />
                                        </svg>
                                        Driver
                                    </a>
                                    <a href="#" class="menu-item  <?php echo ($currentPage === '') ? 'active' : ''; ?>">
