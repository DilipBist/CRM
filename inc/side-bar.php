                    ...
                    <div class="accordion d-flex flex-column gap-2">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <a href="#" class="menu-item accordion-button <?php echo ($currentPage === 'Journal' || $currentPage === 'Payment' || $currentPage === 'Receipt' || $currentPage === 'PDC' || $currentPage === 'Contra' || $currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger' || $currentPage === 'purchaseRequisation' || $currentPage === 'purchaseOrder') ? '' : 'collapsed'; ?>" data-bs-toggle="collapse" data-bs-target="#menu-collapse-one" aria-expanded="<?php echo ($currentPage === '' || $currentPage === '' || $currentPage === 'Receipt' || $currentPage === 'PDC' || $currentPage === 'Contra' || $currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger' || $currentPage === 'purchaseRequisation' || $currentPage
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        === 'purchaseOrder') ? 'true' : 'false'; ?>"
                            ...
                            <div id="menu-collapse-one" class="accordion-collapse collapse <?php echo ($currentPage === 'Journal' || $currentPage === 'Payment' || $currentPage === 'Receipt' || $currentPage === 'PDC' || $currentPage === 'Contra' || $currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger' || $currentPage === 'purchaseRequisation' || $currentPage === 'purchaseOrder') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    ...
                                    <div class="purchse_dropdown">
                                        <div class="accordion d-flex flex-column gap-2 inner_accordion">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <a href="#" class="menu-item accordion-button <?php echo ($currentPage === 'purchaseOrder' || $currentPage === 'purchaseRequisation') ? '' : 'collapsed'; ?>" data-bs-toggle="collapse" data-bs-target="#menu-collapse-purchase" aria-expanded="<?php echo ($currentPage === '' || $currentPage === 'purchaseRequisation') ? 'true' : 'false'; ?>"
                                                ...
                                                <div id="menu-collapse-purchase" class="accordion-collapse collapse <?php echo ($currentPage === 'purchaseOrder' || $currentPage === 'purchaseRequisation') ? 'show' : ''; ?>"
                                                    data-bs-parent="#sidebar-accordion2">
                                                    <div class="accordion-body pb-0">
