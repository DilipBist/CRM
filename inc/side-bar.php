                    ...
                    <div class="accordion d-flex flex-column gap-2">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <a href="#" class="menu-item accordion-button <?php echo ($currentPage === 'Journal' || $currentPage === 'Payment' || $currentPage === 'Receipt' || $currentPage === 'PDC' || $currentPage === 'Contra' || $currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger' || $currentPage === 'purchaseRequisation' || $currentPage === 'purchaseOrder' || $currentPage === 'quotation') ? '' : 'collapsed'; ?>" data-bs-toggle="collapse" data-bs-target="#menu-collapse-one" aria-expanded="<?php echo ($currentPage === '' || $currentPage === '' || $currentPage === 'Receipt' || $currentPage === 'PDC' || $currentPage === 'Contra' || $currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger' || $currentPage === 'purchaseRequisation' || $currentPage  === 'purchaseOrder' || $currentPage === 'quotation') ? 'true' : 'false'; ?>"
                            ...
                            <div id="menu-collapse-one" class="accordion-collapse collapse <?php echo ($currentPage === 'Journal' || $currentPage === 'Payment' || $currentPage === 'Receipt' || $currentPage === 'PDC' || $currentPage === 'Contra' || $currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger' || $currentPage === 'purchaseRequisation' || $currentPage === 'purchaseOrder' || $currentPage === 'quotation') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    ...
                                    <div class="purchse_dropdown">
                                        <div class="accordion d-flex flex-column gap-2 inner_accordion">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <a href="#" class="menu-item accordion-button <?php echo ($currentPage === 'purchaseOrder' || $currentPage === 'purchaseRequisation' || $currentPage === 'quotation') ? '' : 'collapsed'; ?>" data-bs-toggle="collapse" data-bs-target="#menu-collapse-purchase" aria-expanded="<?php echo ($currentPage === '' || $currentPage === 'purchaseRequisation' || $currentPage === 'quotation') ? 'true' : 'false'; ?>"
                                                ...
                                                <div id="menu-collapse-purchase" class="accordion-collapse collapse <?php echo ($currentPage === 'purchaseOrder' || $currentPage === 'purchaseRequisation') || $currentPage === 'quotation' ? 'show' : ''; ?>"
                                                    data-bs-parent="#sidebar-accordion2">
                                                    <div class="accordion-body pb-0">
                                                        ...
                                                        <a href="quotation.php" class="menu-item  <?php echo ($currentPage === 'quotation') ? 'active' : ''; ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                                                                <path d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z" stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M8 10.25H16" stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M8 13.75H14" stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                        ...
                                                        <a href="purchase-order.php" class="menu-item  <?php echo ($currentPage === 'purchaseOrder') ? 'active' : ''; ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                                                                <path d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z" stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M8 10.25H16" stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M8 13.75H14" stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="menu-collapse-two" class="accordion-collapse collapse <?php echo ($currentPage === 'openTrail' || $currentPage === 'trailBalance' || $currentPage === 'balanceSheet' || $currentPage === 'profitLoss' || $currentPage === 'daybook' || $currentPage === 'gledger') ? 'show' : ''; ?>"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <a href="day-book.php" class="menu-item  <?php echo ($currentPage === 'daybook') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="accordion d-flex flex-column gap-2">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <a href="#" class="menu-item accordion-button <?php echo ($currentPage === 'employee' || $currentPage === 'payroll' || $currentPage === 'Holiday' || $currentPage === 'Assets' || $currentPage === 'Events' || $currentPage === 'leave' || $currentPage === 'employeeLeave' || $currentPage === 'employeeAttendance' || $currentPage === 'adminAttendance') ? '' : 'collapsed'; ?>" data-bs-toggle="collapse" data-bs-target="#menu-collapse-hrm" aria-expanded="<?php echo ($currentPage === 'employee' || $currentPage === 'payroll' || $currentPage === 'Holiday' || $currentPage === 'Assets' || $currentPage === 'Events' || $currentPage === 'leave ' || $currentPage === 'employeeLeave' || $currentPage === 'employeeAttendance' || $currentPage === 'adminAttendance') ? 'true' : 'false'; ?>"
                            ...
                            <div id="menu-collapse-hrm" class="accordion-collapse collapse <?php echo ($currentPage === 'employee' || $currentPage === 'payroll' || $currentPage === 'Holiday' || $currentPage === 'Assets' || $currentPage === 'Events' || $currentPage === 'leave' || $currentPage === 'employeeLeave' || $currentPage === 'employeeAttendance' || $currentPage === 'adminAttendance') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    ...
                                    <a href="payroll.php" class="menu-item  <?php echo ($currentPage === 'payroll') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                                            <path d="M12.6604 2.51814L12.6304 2.58814L9.73045 9.31814H6.88045C6.20045 9.31814 5.55045 9.45814 4.96045 9.70814L6.71045 5.52814L6.75045 5.42814L6.82045 5.26814C6.84045 5.20814 6.86045 5.14814 6.89045 5.09814C8.20045 2.06814 9.68045 1.37814 12.6604 2.51814Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M18.0505 9.51807C17.6005 9.37807 17.1205 9.31807 16.6405 9.31807H9.73047L12.6305 2.58807L12.6605 2.51807C12.8105 2.56807 12.9505 2.63807 13.1005 2.69807L15.3105 3.62807C16.5405 4.13807 17.4005 4.66807 17.9205 5.30807C18.0205 5.42807 18.1005 5.53807 18.1705 5.66807C18.2605 5.80807 18.3305 5.94807 18.3705 6.09807C18.4105 6.18807 18.4405 6.27807 18.4605 6.35807C18.7305 7.19807 18.5705 8.22807 18.0505 9.51807Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M21.5222 14.1984V16.1484C21.5222 16.3484 21.5122 16.5484 21.5022 16.7484C21.3122 20.2384 19.3622 21.9984 15.6622 21.9984H7.86221C7.62221 21.9984 7.38221 21.9784 7.15221 21.9484C3.97221 21.7384 2.27221 20.0384 2.06221 16.8584C2.03221 16.6284 2.01221 16.3884 2.01221 16.1484V14.1984C2.01221 12.1884 3.23221 10.4584 4.97221 9.70836C5.57221 9.45836 6.21221 9.31836 6.89221 9.31836H16.6522C17.1422 9.31836 17.6222 9.38836 18.0622 9.51836C20.0522 10.1284 21.5222 11.9884 21.5222 14.1984Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <a href="leave.php" class="menu-item  <?php echo ($currentPage === 'leave' || $currentPage === 'employeeLeave') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path d="M6 1.5V3.75" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12 1.5V3.75" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M2.625 6.82031H15.375" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <a href="admin-attendance.php" class="menu-item  <?php echo ($currentPage === 'adminAttendance' || $currentPage === 'employeeAttendance') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path d="M6 1.5V3.75" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12 1.5V3.75" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M2.625 6.82031H15.375" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <a href="events.php" class="menu-item  <?php echo ($currentPage === 'Events') ? 'active' : ''; ?>">
                    ...
                    <div class="accordion d-flex flex-column gap-2">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <a href="#" class="menu-item accordion-button <?php echo ($currentPage === 'vehicleList' || $currentPage === 'vehicleMaintainance' || $currentPage === 'driverlist' || $currentPage === 'fuelManagement' || $currentPage === 'livelocation') ? '' : 'collapsed'; ?>" data-bs-toggle="collapse" data-bs-target="#menu-collapse-vehicle" aria-expanded="<?php echo ($currentPage === 'vehicleList' || $currentPage === 'vehicleMaintainance' || $currentPage === 'livelocation') ? 'true' : 'false'; ?>"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <path d="M19.001 20.75H18.001C17.591 20.75 17.251 20.41 17.251 20C17.251 19.31 16.691 18.75 16.001 18.75C15.311 18.75 14.751 19.31 14.751 20C14.751 20.41 14.411 20.75 14.001 20.75H10.001C9.59098 20.75 9.25098 20.41 9.25098 20C9.25098 19.31 8.69098 18.75 8.00098 18.75C7.31098 18.75 6.75098 19.31 6.75098 20C6.75098 20.41 6.41098 20.75 6.00098 20.75H5.00098C2.93098 20.75 1.25098 19.07 1.25098 17V14C1.25098 13.59 1.59098 13.25 2.00098 13.25H13.001C13.691 13.25 14.251 12.69 14.251 12V5C14.251 4.59 14.591 4.25 15.001 4.25H16.841C17.831 4.25 18.741 4.78001 19.231 5.64001L20.941 8.63C21.071 8.86 21.071 9.15 20.941 9.38C20.811 9.61 20.561 9.75 20.291 9.75H19.001C18.861 9.75 18.751 9.86 18.751 10V13C18.751 13.14 18.861 13.25 19.001 13.25H22.001C22.411 13.25 22.751 13.59 22.751 14V17C22.751 19.07 21.071 20.75 19.001 20.75ZM18.651 19.25H19.001C20.241 19.25 21.251 18.24 21.251 17V14.75H19.001C18.041 14.75 17.251 13.96 17.251 13V10C17.251 9.04 18.031 8.25 19.001 8.25L17.931 6.38C17.711 5.99 17.291 5.75 16.841 5.75H15.751V12C15.751 13.52 14.521 14.75 13.001 14.75H2.75098V17C2.75098 18.24 3.76098 19.25 5.00098 19.25H5.35098C5.68098 18.1 6.74098 17.25 8.00098 17.25C9.26098 17.25 10.321 18.1 10.651 19.25H13.361C13.691 18.1 14.751 17.25 16.011 17.25C17.271 17.25 18.321 18.1 18.651 19.25Z" fill="#fff" />
                                        <path d="M8.00098 22.75C6.48098 22.75 5.25098 21.52 5.25098 20C5.25098 18.48 6.48098 17.25 8.00098 17.25C9.52098 17.25 10.751 18.48 10.751 20C10.751 21.52 9.52098 22.75 8.00098 22.75ZM8.00098 18.75C7.31098 18.75 6.75098 19.31 6.75098 20C6.75098 20.69 7.31098 21.25 8.00098 21.25C8.69098 21.25 9.25098 20.69 9.25098 20C9.25098 19.31 8.69098 18.75 8.00098 18.75Z" fill="#fff" />
                                        <path d="M16.001 22.75C14.481 22.75 13.251 21.52 13.251 20C13.251 18.48 14.481 17.25 16.001 17.25C17.521 17.25 18.751 18.48 18.751 20C18.751 21.52 17.521 22.75 16.001 22.75ZM16.001 18.75C15.311 18.75 14.751 19.31 14.751 20C14.751 20.69 15.311 21.25 16.001 21.25C16.691 21.25 17.251 20.69 17.251 20C17.251 19.31 16.691 18.75 16.001 18.75Z" fill="#fff" />
                                        <path d="M22.001 14.75H19.001C18.041 14.75 17.251 13.96 17.251 13V10C17.251 9.04 18.041 8.25 19.001 8.25H20.291C20.561 8.25 20.811 8.39 20.941 8.63L22.651 11.63C22.711 11.74 22.751 11.87 22.751 12V14C22.751 14.41 22.411 14.75 22.001 14.75ZM19.001 9.75C18.861 9.75 18.751 9.86 18.751 10V13C18.751 13.14 18.861 13.25 19.001 13.25H21.251V12.2L19.851 9.75H19.001Z" fill="#fff" />
                                    </svg>
                                    Vehicle
                                </a>
                            </h2>
                            <div id="menu-collapse-vehicle" class="accordion-collapse collapse <?php echo ($currentPage === 'vehicleList' || $currentPage === 'vehicleMaintainance' || $currentPage === 'driverlist' || $currentPage === 'fuelManagement' || $currentPage === 'livelocation') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    ...
                                    <a href="driver-list.php" class="menu-item  <?php echo ($currentPage === 'driverlist') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <path d="M16 17.4101C15.59 17.4101 15.25 17.0701 15.25 16.6601C15.25 15.2801 13.79 14.1501 12 14.1501C10.21 14.1501 8.75 15.2801 8.75 16.6601C8.75 17.0701 8.41 17.4101 8 17.4101C7.59 17.4101 7.25 17.0701 7.25 16.6601C7.25 14.4501 9.38 12.6501 12 12.6501C14.62 12.6501 16.75 14.4501 16.75 16.6601C16.75 17.0701 16.41 17.4101 16 17.4101Z" fill="#fff" />
                                        </svg>
                                        Driver
                                    </a>
                                    ...
                                    <a href="vehicle-maintaince.php" class="menu-item  <?php echo ($currentPage === 'vehicleMaintainance') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <path d="M19.9596 22.75H18.0796C16.4596 22.75 16.1496 21.82 15.9496 21.21L15.7496 20.61C15.4896 19.85 15.4596 19.75 14.5596 19.75H9.4396C8.5396 19.75 8.4796 19.92 8.2496 20.61L8.0496 21.21C7.8396 21.83 7.5396 22.75 5.9196 22.75H4.0396C3.2496 22.75 2.4896 22.42 1.9596 21.84C1.4396 21.27 1.1896 20.51 1.2596 19.75L1.8196 13.66C1.9696 12.01 2.4096 10.25 5.6196 10.25H18.3796C21.5896 10.25 22.0196 12.01 22.1796 13.66L22.7396 19.75C22.8096 20.51 22.5596 21.27 22.0396 21.84C21.5096 22.42 20.7496 22.75 19.9596 22.75ZM9.4396 18.25H14.5596C16.3796 18.25 16.8096 19.06 17.1696 20.12L17.3796 20.74C17.5496 21.25 17.5496 21.26 18.0896 21.26H19.9696C20.3396 21.26 20.6896 21.11 20.9396 20.84C21.1796 20.58 21.2896 20.25 21.2596 19.9L20.6996 13.81C20.5696 12.46 20.4096 11.76 18.3996 11.76H5.6196C3.5996 11.76 3.4396 12.46 3.3196 13.81L2.7596 19.9C2.7296 20.25 2.8396 20.58 3.0796 20.84C3.3196 21.11 3.6796 21.26 4.0496 21.26H5.9296C6.4696 21.26 6.4696 21.25 6.6396 20.75L6.8396 20.14C7.0896 19.34 7.4596 18.25 9.4396 18.25Z" fill="#fff" />
                                            <path d="M3.99951 8.75H2.99951C2.58951 8.75 2.24951 8.41 2.24951 8C2.24951 7.59 2.58951 7.25 2.99951 7.25H3.99951C4.40951 7.25 4.74951 7.59 4.74951 8C4.74951 8.41 4.40951 8.75 3.99951 8.75Z" fill="#fff" />
                                            <path d="M20.9995 8.75H19.9995C19.5895 8.75 19.2495 8.41 19.2495 8C19.2495 7.59 19.5895 7.25 19.9995 7.25H20.9995C21.4095 7.25 21.7495 7.59 21.7495 8C21.7495 8.41 21.4095 8.75 20.9995 8.75Z" fill="#fff" />
                                            <path d="M11.9995 5.75C11.5895 5.75 11.2495 5.41 11.2495 5V3C11.2495 2.59 11.5895 2.25 11.9995 2.25C12.4095 2.25 12.7495 2.59 12.7495 3V5C12.7495 5.41 12.4095 5.75 11.9995 5.75Z" fill="#fff" />
                                            <path d="M13.4995 5.75H10.4995C10.0895 5.75 9.74951 5.41 9.74951 5C9.74951 4.59 10.0895 4.25 10.4995 4.25H13.4995C13.9095 4.25 14.2495 4.59 14.2495 5C14.2495 5.41 13.9095 5.75 13.4995 5.75Z" fill="#fff" />
                                            <path d="M8.99951 15.75H5.99951C5.58951 15.75 5.24951 15.41 5.24951 15C5.24951 14.59 5.58951 14.25 5.99951 14.25H8.99951C9.40951 14.25 9.74951 14.59 9.74951 15C9.74951 15.41 9.40951 15.75 8.99951 15.75Z" fill="#fff" />
                                            <path d="M17.9995 15.75H14.9995C14.5895 15.75 14.2495 15.41 14.2495 15C14.2495 14.59 14.5895 14.25 14.9995 14.25H17.9995C18.4095 14.25 18.7495 14.59 18.7495 15C18.7495 15.41 18.4095 15.75 17.9995 15.75Z" fill="#fff" />
                                        </svg>
                                        Vehicle Maintenance
                                    </a>

                                    <a href="live-location.php" class="menu-item  <?php echo ($currentPage === 'livelocation') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                                            <path d="M11.9999 14.1699C9.86988 14.1699 8.12988 12.4399 8.12988 10.2999C8.12988 8.15994 9.86988 6.43994 11.9999 6.43994C14.1299 6.43994 15.8699 8.16994 15.8699 10.3099C15.8699 12.4499 14.1299 14.1699 11.9999 14.1699ZM11.9999 7.93994C10.6999 7.93994 9.62988 8.99994 9.62988 10.3099C9.62988 11.6199 10.6899 12.6799 11.9999 12.6799C13.3099 12.6799 14.3699 11.6199 14.3699 10.3099C14.3699 8.99994 13.2999 7.93994 11.9999 7.93994Z" fill="#fff" />
