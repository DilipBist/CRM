        ...
        <div class="side_bar_logo d-flex align-items-center gap-3 justify-content-between">
            ...
            <div class="sidebar_close">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none">
                    <path
                        d="M17.0002 3.75H10.2802C8.87018 3.75 7.53018 4.34 6.58018 5.39L3.05018 9.27C1.64018 10.82 1.64018 13.18 3.05018 14.73L6.58018 18.61C7.53018 19.65 8.87018 20.25 10.2802 20.25H17.0002C19.7602 20.25 22.0002 18.01 22.0002 15.25V8.75C22.0002 5.99 19.7602 3.75 17.0002 3.75ZM16.5302 13.94C16.8202 14.23 16.8202 14.71 16.5302 15C16.3802 15.15 16.1902 15.22 16.0002 15.22C15.8102 15.22 15.6202 15.15 15.4702 15L13.5302 13.06L11.5902 15C11.4402 15.15 11.2502 15.22 11.0602 15.22C10.8702 15.22 10.6802 15.15 10.5302 15C10.2402 14.71 10.2402 14.23 10.5302 13.94L12.4702 12L10.5302 10.06C10.2402 9.77 10.2402 9.29 10.5302 9C10.8202 8.71 11.3002 8.71 11.5902 9L13.5302 10.94L15.4702 9C15.7602 8.71 16.2402 8.71 16.5302 9C16.8202 9.29 16.8202 9.77 16.5302 10.06L14.5902 12L16.5302 13.94Z"
                        fill="white" />
                </svg>
            </div>
        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <a href="#"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                        fill="none">
                                        <path
                                            d="M17.01 12.73C17.601 12.73 18.08 12.251 18.08 11.66C18.08 11.0691 17.601 10.5901 17.01 10.5901C16.4191 10.5901 15.94 11.0691 15.94 11.66C15.94 12.251 16.4191 12.73 17.01 12.73Z"
                                            stroke="#F2F6FA" stroke-width="1.5" stroke-linecap="round"
                                        ...
                                        <path
                                            ...
                                            stroke="#F2F6FA" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M9 15.7V19.9999" stroke="#F2F6FA" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M2 11.8999H12" stroke="#F2F6FA" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M5.95001 20H12" stroke="#F2F6FA" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M17.0101 12.73C17.601 12.73 18.08 12.251 18.08 11.66C18.08 11.0691 17.601 10.5901 17.0101 10.5901C16.4191 10.5901 15.9401 11.0691 15.9401 11.66C15.9401 12.251 16.4191 12.73 17.0101 12.73Z"
                                            stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            ...
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M19.15 17.0101C19.15 18.1901 18.19 19.1501 17.01 19.1501C15.83 19.1501 14.87 18.1901 14.87 17.0101C14.87 16.5201 15.04 16.0601 15.32 15.7001C15.71 15.2001 16.32 14.8701 17.01 14.8701C17.55 14.8701 18.04 15.0701 18.41 15.3901C18.86 15.7901 19.15 16.3701 19.15 17.0101Z"
                                            stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M17.0101 12.73C17.601 12.73 18.08 12.251 18.08 11.66C18.08 11.0691 17.601 10.5901 17.0101 10.5901C16.4191 10.5901 15.9401 11.0691 15.9401 11.66C15.9401 12.251 16.4191 12.73 17.0101 12.73Z"
                            ...
                            <div id="menu-collapse-construction"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <a href="project-list.php?view=subcontractor"
                                        class="menu-item <?php echo ($currentPage === 'subcontractor') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 18 18" fill="none">
                                            <path
                                                d="M10.5 5.0625H7.5C6.78 5.0625 5.4375 5.0625 5.4375 3C5.4375 0.9375 6.78 0.9375 7.5 0.9375H10.5C11.22 0.9375 12.5625 0.9375 12.5625 3C12.5625 3.72 12.5625 5.0625 10.5 5.0625ZM7.5 2.0625C6.7575 2.0625 6.5625 2.0625 6.5625 3C6.5625 3.9375 6.7575 3.9375 7.5 3.9375H10.5C11.4375 3.9375 11.4375 3.7425 11.4375 3C11.4375 2.0625 11.2425 2.0625 10.5 2.0625H7.5Z"
                                    ...
                                    <a href="labour-list.php"
                                        class="menu-item <?php echo ($currentPage === 'labourlist') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
                                            <path
                                                d="M9.9998 18.9579C9.44147 18.9579 8.8748 18.8162 8.3748 18.5246L3.4248 15.6662C2.4248 15.0829 1.7998 14.0079 1.7998 12.8496V7.14961C1.7998 5.99127 2.4248 4.91627 3.4248 4.33294L8.3748 1.47461C9.3748 0.891276 10.6165 0.891276 11.6248 1.47461L16.5748 4.33294C17.5748 4.91627 18.1998 5.99127 18.1998 7.14961V12.8496C18.1998 14.0079 17.5748 15.0829 16.5748 15.6662L11.6248 18.5246C11.1248 18.8162 10.5581 18.9579 9.9998 18.9579ZM9.9998 2.29126C9.65814 2.29126 9.30814 2.38293 8.9998 2.55793L4.0498 5.41626C3.43314 5.77459 3.0498 6.43294 3.0498 7.14961V12.8496C3.0498 13.5579 3.43314 14.2246 4.0498 14.5829L8.9998 17.4413C9.61647 17.7996 10.3831 17.7996 10.9998 17.4413L15.9498 14.5829C16.5665 14.2246 16.9498 13.5662 16.9498 12.8496V7.14961C16.9498 6.44127 16.5665 5.77459 15.9498 5.41626L10.9998 2.55793C10.6915 2.38293 10.3415 2.29126 9.9998 2.29126Z"
                                                fill="#F2F6FA" />
                                            <path
                                                d="M10.0003 9.79151C8.58359 9.79151 7.43359 8.6415 7.43359 7.22483C7.43359 5.80817 8.58359 4.6582 10.0003 4.6582C11.4169 4.6582 12.5669 5.80817 12.5669 7.22483C12.5669 8.6415 11.4169 9.79151 10.0003 9.79151ZM10.0003 5.9082C9.27526 5.9082 8.68359 6.49983 8.68359 7.22483C8.68359 7.94983 9.27526 8.54151 10.0003 8.54151C10.7253 8.54151 11.3169 7.94983 11.3169 7.22483C11.3169 6.49983 10.7253 5.9082 10.0003 5.9082Z"
                                                fill="#F2F6FA" />
                                            <path
                                                d="M13.3337 14.5076C12.992 14.5076 12.7087 14.2243 12.7087 13.8826C12.7087 12.7326 11.492 11.791 10.0003 11.791C8.50866 11.791 7.29199 12.7326 7.29199 13.8826C7.29199 14.2243 7.00866 14.5076 6.66699 14.5076C6.32533 14.5076 6.04199 14.2243 6.04199 13.8826C6.04199 12.041 7.81699 10.541 10.0003 10.541C12.1837 10.541 13.9587 12.041 13.9587 13.8826C13.9587 14.2243 13.6753 14.5076 13.3337 14.5076Z"
                                                fill="#F2F6FA" />
                                        </svg>
                                        Labors
                                    </a>
                ...
                <div class="admin_dash_btns">
                    <div class="accordion d-flex flex-column gap-2">
                        <div class="accordion-item">
                                ...
                                <a href="#"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                        ...
                                        <path
                                            ...
                                            fill="#FCFCFC" />
                                        <path
                                            d="M4.42988 20.7401C4.23988 20.7401 4.04988 20.6701 3.89988 20.5201L2.90988 19.5301C2.61988 19.2401 2.61988 18.76 2.90988 18.47C3.19988 18.18 3.67988 18.18 3.96988 18.47L4.44988 18.9501L6.04988 17.47C6.34988 17.19 6.82988 17.2101 7.10988 17.5101C7.38988 17.8101 7.36988 18.2901 7.06988 18.5701L4.93988 20.54C4.78988 20.67 4.60988 20.7401 4.42988 20.7401Z"
                                            fill="#FCFCFC" />
                                        <path
                            ...
                            <div id="menu-collapse-one"
                                class="accordion-collapse collapse <?php echo ($currentPage === 'Journal' || $currentPage === 'Payment' || $currentPage === 'Receipt' || $currentPage === 'PDC' || $currentPage === 'Contra' || $currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger' || $currentPage === 'purchaseRequisation' || $currentPage === 'purchaseOrder' || $currentPage === 'quotation') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    ...
                                    <div class="accordion d-flex flex-column gap-2 inner_accordion">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <a href="#"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                        ...
                                                        <path
                                                            d="M9.50049 13.75C9.50049 14.72 10.2505 15.5 11.1705 15.5H13.0505C13.8505 15.5 14.5005 14.82 14.5005 13.97C14.5005 13.06 14.1005 12.73 13.5105 12.52L10.5005 11.47C9.91049 11.26 9.5105 10.94 9.5105 10.02C9.5105 9.17999 10.1605 8.48999 10.9605 8.48999H12.8405C13.7605 8.48999 14.5105 9.26999 14.5105 10.24"
                                                            stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M12.0005 7.5V16.5" stroke="#FCFCFC" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M22.0005 12C22.0005 17.52 17.5205 22 12.0005 22C6.48049 22 2.00049 17.52 2.00049 12C2.00049 6.48 6.48049 2 12.0005 2"
                                                            stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M22.0005 6V2H18.0005" stroke="#FCFCFC"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M17.0005 7L22.0005 2" stroke="#FCFCFC"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                    Accounting
                                            ...
                                            <div id="menu-collapse-inner"
                                                class="accordion-collapse collapse <?php echo ($currentPage === 'Journal' || $currentPage === 'Payment' || $currentPage === 'Receipt' || $currentPage === 'PDC' || $currentPage === 'Contra' || $currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger') ? 'show' : ''; ?>"
                                                data-bs-parent="#sidebar-accordion1">
                                                <div class="accordion-body pb-0">
                                                    <a href="journal-vourcher.php"
                                                        class="menu-item  <?php echo ($currentPage === 'Journal') ? 'active' : ''; ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <path
                                                                ...
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M8 10.25H16" stroke="#FCFCFC" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M8 13.75H14" stroke="#FCFCFC" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                        Journal Vouchar
                                                    </a>
                                                    <a href="payment-voucher.php"
                                                        class="menu-item  <?php echo ($currentPage === 'Payment') ? 'active' : ''; ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <path
                                                                d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z"
                                                    ...
                                                    <a href="receipt-vouchar.php"
                                                        class="menu-item  <?php echo ($currentPage === 'Receipt') ? 'active' : ''; ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <path
                                                                d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z"
                                                    ...
                                                    <a href="contra.php"
                                                        class="menu-item  <?php echo ($currentPage === 'Contra') ? 'active' : ''; ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <path
                                                                d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z"
                                                    ...
                                                    <a href="PDC.php"
                                                        class="menu-item  <?php echo ($currentPage === 'PDC') ? 'active' : ''; ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <path
                                                                d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z"
                                                    ...
                                                    <div class="accordion d-flex flex-column gap-2 inner_accordion">
                                                        <div class="accordion-item">
                                                                ...
                                                                <a href="#"
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            stroke-linejoin="round" />
                                                                        <path d="M12.0005 7.5V16.5" stroke="#FCFCFC"
                                                                            stroke-width="1.5" stroke-linecap="round"
                                                                            stroke-linejoin="round" />
                                                                        <path
                                                                            d="M22.0005 12C22.0005 17.52 17.5205 22 12.0005 22C6.48049 22 2.00049 17.52 2.00049 12C2.00049 6.48 6.48049 2 12.0005 2"
                                                            ...
                                                            <div id="menu-collapse-innerTwo"
                                                                class="accordion-collapse collapse <?php echo ($currentPage === 'GeneralLegder' || $currentPage === 'accountingGroup' || $currentPage === 'Ledger') ? 'show' : ''; ?>"
                                                                data-bs-parent="#sidebar-accordion2">
                                                                <div class="accordion-body pb-0">
                                                                    <a href="account-groups.php"
                                                                        class="menu-item  <?php echo ($currentPage === 'accountingGroup') ? 'active' : ''; ?>">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            <path
                                                                                ...
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round" />
                                                                            <path d="M8 10.25H16" stroke="#FCFCFC"
                                                                                stroke-width="1.5"
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round" />
                                                                            <path d="M8 13.75H14" stroke="#FCFCFC"
                                                                                stroke-width="1.5"
                                                                                stroke-linecap="round"
                                                                                stroke-linejoin="round" />
                                                                        </svg>
                                                                    ...
                                                                    <a href="general-ledger.php"
                                                                        class="menu-item  <?php echo ($currentPage === 'GeneralLegder') ? 'active' : ''; ?>">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="18" height="18" viewBox="0 0 24 24"
                                                                            fill="none">
                                                                            <path
                                                                    ...
                                                                    <a href="ledger.php"
                                                                        class="menu-item  <?php echo ($currentPage === 'Ledger') ? 'active' : ''; ?>">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="18" height="18" viewBox="0 0 24 24"
                                                                            fill="none">
                                                                            <path
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <a href="#"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <path d="M2.00049 8.5H13.5005" stroke="#FCFCFC"
                                                                stroke-width="1.5" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M6.00049 16.5H8.00049" stroke="#FCFCFC"
                                                                stroke-width="1.5" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M10.5005 16.5H14.5005" stroke="#FCFCFC"
                                                                stroke-width="1.5" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path
                                                                d="M22.0005 11.03V16.11C22.0005 19.62 21.1105 20.5 17.5605 20.5H6.44049C2.89049 20.5 2.00049 19.62 2.00049 16.11V7.89C2.00049 4.38 2.89049 3.5 6.44049 3.5H13.5005"
                                                                stroke="#FCFCFC" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M16.5005 6L18.0005 7.5L22.0005 3.5"
                                                                stroke="#FCFCFC" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                        Purchase Entries
                                                ...
                                                <div id="menu-collapse-purchase"
                                                    class="accordion-collapse collapse <?php echo ($currentPage === 'purchaseOrder' || $currentPage === 'purchaseRequisation') || $currentPage === 'quotation' ? 'show' : ''; ?>"
                                                    data-bs-parent="#sidebar-accordion2">
                                                    <div class="accordion-body pb-0">
                                                        <a href="purchase-entries-requisation.php"
                                                            class="menu-item  <?php echo ($currentPage === 'purchaseRequisation') ? 'active' : ''; ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                                height="18" viewBox="0 0 24 24" fill="none">
                                                                <path
                                                                    d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z"
                                                        ...
                                                        <a href="quotation.php"
                                                            class="menu-item  <?php echo ($currentPage === 'quotation') ? 'active' : ''; ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                                height="18" viewBox="0 0 24 24" fill="none">
                                                                <path
                                                                    d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z"
                                                        ...
                                                        <a href="purchase-order.php"
                                                            class="menu-item  <?php echo ($currentPage === 'purchaseOrder') ? 'active' : ''; ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                                height="18" viewBox="0 0 24 24" fill="none">
                                                                <path
                                                                    d="M20 7.04V16.96C20 18.48 19.86 19.56 19.5 20.33C19.5 20.34 19.49 20.36 19.48 20.37C19.26 20.65 18.97 20.79 18.63 20.79C18.1 20.79 17.46 20.44 16.77 19.7C15.95 18.82 14.69 18.89 13.97 19.85L12.96 21.19C12.56 21.73 12.03 22 11.5 22C10.97 22 10.44 21.73 10.04 21.19L9.02002 19.84C8.31002 18.89 7.05999 18.82 6.23999 19.69L6.22998 19.7C5.09998 20.91 4.10002 21.09 3.52002 20.37C3.51002 20.36 3.5 20.34 3.5 20.33C3.14 19.56 3 18.48 3 16.96V7.04C3 5.52 3.14 4.44 3.5 3.67C3.5 3.66 3.50002 3.65 3.52002 3.64C4.09002 2.91 5.09998 3.09 6.22998 4.3L6.23999 4.31C7.05999 5.18 8.31002 5.11 9.02002 4.16L10.04 2.81C10.44 2.27 10.97 2 11.5 2C12.03 2 12.56 2.27 12.96 2.81L13.97 4.15C14.69 5.11 15.95 5.18 16.77 4.3C17.46 3.56 18.1 3.21 18.63 3.21C18.97 3.21 19.26 3.36 19.48 3.64C19.5 3.65 19.5 3.66 19.5 3.67C19.86 4.44 20 5.52 20 7.04Z"
                ...
                <div class="admin_dash_btns">
                    ...
                    <div class="accordion d-flex flex-column gap-2">
                        <div class="accordion-item">
                                ...
                                <a href="#"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                        ...
                                        <path
                                            ...
                                            stroke-linejoin="round" />
                                        <path d="M12 5.48999V20.49" stroke="white" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                            ...
                            <div id="menu-collapse-two"
                                class="accordion-collapse collapse <?php echo ($currentPage === 'openTrail' || $currentPage === 'trailBalance' || $currentPage === 'balanceSheet' || $currentPage === 'profitLoss' || $currentPage === 'daybook' || $currentPage === 'gledger') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    <a href="opening-trails.php"
                                        class="menu-item  <?php echo ($currentPage === 'openTrail') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path d="M12.06 16.5V11.5" stroke="white" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M14.5 14H9.5" stroke="white" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                    ...
                                    <a href="trail-balance.php"
                                        class="menu-item  <?php echo ($currentPage === 'trailBalance') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M12.6604 2.51814L12.6304 2.58814L9.73045 9.31814H6.88045C6.20045 9.31814 5.55045 9.45814 4.96045 9.70814L6.71045 5.52814L6.75045 5.42814L6.82045 5.26814C6.84045 5.20814 6.86045 5.14814 6.89045 5.09814C8.20045 2.06814 9.68045 1.37814 12.6604 2.51814Z"
                                                stroke="white" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                                ...
                                                stroke-linejoin="round" />
                                            <path
                                                d="M21.5222 14.1984V16.1484C21.5222 16.3484 21.5122 16.5484 21.5022 16.7484C21.3122 20.2384 19.3622 21.9984 15.6622 21.9984H7.86221C7.62221 21.9984 7.38221 21.9784 7.15221 21.9484C3.97221 21.7384 2.27221 20.0384 2.06221 16.8584C2.03221 16.6284 2.01221 16.3884 2.01221 16.1484V14.1984C2.01221 12.1884 3.23221 10.4584 4.97221 9.70836C5.57221 9.45836 6.21221 9.31836 6.89221 9.31836H16.6522C17.1422 9.31836 17.6222 9.38836 18.0622 9.51836C20.0522 10.1284 21.5222 11.9884 21.5222 14.1984Z"
                                                stroke="white" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                                d="M6.71049 5.52832L4.96049 9.70832C3.22049 10.4583 2.00049 12.1883 2.00049 14.1983V11.2683C2.00049 8.42832 4.02049 6.05832 6.71049 5.52832Z"
                                                stroke="white" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                                d="M21.5191 11.2677V14.1977C21.5191 11.9977 20.0591 10.1277 18.0591 9.52766C18.5791 8.22766 18.7291 7.20766 18.4791 6.35766C18.4591 6.26766 18.4291 6.17766 18.3891 6.09766C20.2491 7.05766 21.5191 9.02766 21.5191 11.2677Z"
                                                stroke="white" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                        Trail Balance
                                    </a>
                                    <a href="profit-loss.php"
                                        class="menu-item  <?php echo ($currentPage === 'profitLoss') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                                ...
                                                fill="white" />
                                            <path
                                                d="M4.99982 17.7501C4.82982 17.7501 4.64982 17.6901 4.50982 17.5701C4.19982 17.3001 4.15982 16.8301 4.42982 16.5101L9.01982 11.1501C9.51982 10.5701 10.2398 10.2201 10.9998 10.1901C11.7598 10.1701 12.5098 10.4501 13.0498 10.9901L13.9998 11.9401C14.2498 12.1901 14.5798 12.3101 14.9298 12.3101C15.2798 12.3001 15.5998 12.1401 15.8298 11.8701L20.4198 6.51008C20.6898 6.20008 21.1598 6.16006 21.4798 6.43006C21.7898 6.70006 21.8298 7.17006 21.5598 7.49006L16.9698 12.8501C16.4698 13.4301 15.7498 13.7801 14.9898 13.8101C14.2298 13.8301 13.4798 13.5501 12.9398 13.0101L11.9998 12.0601C11.7498 11.8101 11.4198 11.6801 11.0698 11.6901C10.7198 11.7001 10.3998 11.8601 10.1698 12.1301L5.57982 17.4901C5.41982 17.6601 5.20982 17.7501 4.99982 17.7501Z"
                                                fill="whtie" />
                                        </svg>
                                        Profit & Loss
                                    </a>

                                    <a href="balance-sheet.php"
                                        class="menu-item  <?php echo ($currentPage === 'balanceSheet') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="white" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9 13.0098H12" stroke="white" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9 9.00977H12" stroke="white" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M5.99561 13H6.00459" stroke="white" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M5.99561 9H6.00459" stroke="white" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        Balance Sheet
                                    </a>
                                    ...
                                    <a href="day-book.php"
                                        class="menu-item  <?php echo ($currentPage === 'daybook') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="white" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M12 8.1001V17.6601" stroke="white" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        Day book
                                    </a>
                                    ...
                                    <a href="ar-general-legder.php"
                                        class="menu-item  <?php echo ($currentPage === 'gledger') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            ...
                                            <path d="M16 2V5" stroke="white" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M7 11H15" stroke="white" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M7 15H12" stroke="white" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                                d="M15 22H9C4 22 3 19.94 3 15.82V9.65C3 4.95 4.67 3.69 8 3.5H16C19.33 3.68 21 4.95 21 9.65V16"
                                                stroke="white" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M21 16L15 22V19C15 17 16 16 18 16H21Z" stroke="white"
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <a href="#"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                        fill="none">
                                        <path opacity="0.8" d="M14.4404 19.0498L15.9604 20.5698L19.0004 17.5298"
                                            stroke="white" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path opacity="0.8"
                            ...
                            <div id="menu-collapse-hrm"
                                class="accordion-collapse collapse <?php echo ($currentPage === 'employee' || $currentPage === 'payroll' || $currentPage === 'Holiday' || $currentPage === 'Assets' || $currentPage === 'Events' || $currentPage === 'leave' || $currentPage === 'employeeLeave' || $currentPage === 'employeeAttendance' || $currentPage === 'adminAttendance') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    <a href="employee.php"
                                        class="menu-item  <?php echo ($currentPage === 'employee') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                    ...
                                    <a href="payroll.php"
                                        class="menu-item  <?php echo ($currentPage === 'payroll') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M12.6604 2.51814L12.6304 2.58814L9.73045 9.31814H6.88045C6.20045 9.31814 5.55045 9.45814 4.96045 9.70814L6.71045 5.52814L6.75045 5.42814L6.82045 5.26814C6.84045 5.20814 6.86045 5.14814 6.89045 5.09814C8.20045 2.06814 9.68045 1.37814 12.6604 2.51814Z"
                                    ...
                                    <a href="holyday.php"
                                        class="menu-item  <?php echo ($currentPage === 'Holiday') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 18 18" fill="none">
                                            <path d="M6 1.5V3.75" stroke="#F2F6FA" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12 1.5V3.75" stroke="#F2F6FA" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M2.625 6.82031H15.375" stroke="#F2F6FA" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                                ...
                                                stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M11.7713 10.2734H11.778" stroke="#F2F6FA" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M11.7713 12.5234H11.778" stroke="#F2F6FA" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M8.99588 10.2734H9.00262" stroke="#F2F6FA" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M8.99588 12.5234H9.00262" stroke="#F2F6FA" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M6.22049 10.2734H6.22723" stroke="#F2F6FA" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M6.22049 12.5234H6.22723" stroke="#F2F6FA" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        Holiday
                                    </a>
                                    ...
                                    <a href="leave.php"
                                        class="menu-item  <?php echo ($currentPage === 'leave' || $currentPage === 'employeeLeave') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 18 18" fill="none">
                                            <path d="M6 1.5V3.75" stroke="#F2F6FA" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            ...
                                            <path d="M2.625 6.82031H15.375" stroke="#F2F6FA" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                                d="M14.4083 11.8282L11.7533 14.4832C11.6483 14.5882 11.5508 14.7832 11.5283 14.9257L11.3858 15.9382C11.3333 16.3057 11.5883 16.5607 11.9558 16.5082L12.9683 16.3657C13.1108 16.3432 13.3133 16.2457 13.4108 16.1407L16.0658 13.4857C16.5233 13.0282 16.7408 12.4957 16.0658 11.8207C15.3983 11.1532 14.8658 11.3707 14.4083 11.8282Z"
                                                stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M14.0254 12.2109C14.2504 13.0209 14.8804 13.6509 15.6904 13.8759"
                                                stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                                d="M9 16.5H6C3.375 16.5 2.25 15 2.25 12.75V6.375C2.25 4.125 3.375 2.625 6 2.625H12C14.625 2.625 15.75 4.125 15.75 6.375V9"
                                                stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M8.99588 10.2734H9.00262" stroke="#F2F6FA" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <a href="admin-attendance.php"
                                        class="menu-item  <?php echo ($currentPage === 'adminAttendance' || $currentPage === 'employeeAttendance') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 18 18" fill="none">
                                            <path d="M6 1.5V3.75" stroke="#F2F6FA" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            ...
                                            <path d="M2.625 6.82031H15.375" stroke="#F2F6FA" stroke-width="1.5"
                                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                                d="M16.5 14.25C16.5 14.8125 16.3425 15.345 16.065 15.795C15.5475 16.665 14.595 17.25 13.5 17.25C12.7425 17.25 12.0525 16.9725 11.5275 16.5C11.295 16.305 11.0925 16.065 10.935 15.795C10.6575 15.345 10.5 14.8125 10.5 14.25C10.5 12.5925 11.8425 11.25 13.5 11.25C14.4 11.25 15.2025 11.6475 15.75 12.27C16.215 12.8025 16.5 13.4925 16.5 14.25Z"
                                                stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.3301 14.2506L13.0726 14.9931L14.6701 13.5156" stroke="#F2F6FA"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                    ...
                    <div class="accordion d-flex flex-column gap-2">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <a href="#"
                                    class="menu-item accordion-button <?php echo ($currentPage === 'crmaccount' || $currentPage === 'crmcampaigns' || $currentPage === 'crmmeeting' || $currentPage === 'crmtask') ? '' : 'collapsed'; ?>"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="15" viewBox="0 0 16 18" fill="none">
                                        <mask id="path-1-inside-1_21822_87689" fill="white">
                                            <path d="M2.57492e-07 16.6568C2.57492e-07 17.0936 0.348283 17.449 0.776388 17.449H2.27609C2.33838 17.449 2.40471 17.4236 2.45324 17.3741L4.40149 15.3861C4.44624 15.3405 4.47483 15.2752 4.47483 15.2054V12.0727C4.47483 11.6358 4.12655 11.2804 3.69848 11.2804H2.48791V10.2093C2.48791 10.1191 2.55985 10.0456 2.64832 10.0456H7.49311V11.2804H6.28254C5.85447 11.2804 5.50619 11.6358 5.50619 12.0726V16.6568C5.50619 17.0936 5.85447 17.449 6.28254 17.449H7.78224C7.84467 17.449 7.9111 17.4234 7.95939 17.3741L9.90764 15.3861C9.95173 15.3411 9.98099 15.2761 9.98099 15.2054V12.0727C9.98099 11.6358 9.6327 11.2804 9.20463 11.2804H7.99409V10.0457H12.8389C12.9273 10.0457 12.9993 10.1191 12.9993 10.2094V11.2805H11.7887C11.3606 11.2805 11.0123 11.6359 11.0123 12.0727V16.6568C11.0123 17.0936 11.3606 17.449 11.7887 17.449H13.2884C13.3527 17.449 13.4179 17.4228 13.4656 17.3741L15.4138 15.3861C15.4592 15.3399 15.4872 15.2739 15.4872 15.2054V14.0573C15.4872 13.9161 15.3751 13.8017 15.2367 13.8017C15.0983 13.8017 14.9862 13.9161 14.9862 14.0573V14.9498H13.8143C13.3862 14.9498 13.0379 15.3052 13.0379 15.742V16.9378H11.7887C11.6369 16.9378 11.5133 16.8117 11.5133 16.6568V12.0727C11.5133 11.9177 11.6369 11.7916 11.7887 11.7916H14.7108C14.8626 11.7916 14.9862 11.9177 14.9862 12.0727V12.8644C14.9862 13.0056 15.0983 13.12 15.2367 13.12C15.3751 13.12 15.4872 13.0056 15.4872 12.8644V12.0727C15.4872 11.6358 15.1389 11.2804 14.7108 11.2804H13.5002V10.2093C13.5002 9.8372 13.2035 9.53443 12.8389 9.53443H7.99406V8.25641H10.7779C11.1027 8.25641 11.3669 7.98684 11.3669 7.65544V7.15146C11.3669 7.01026 11.2548 6.89586 11.1164 6.89586C10.978 6.89586 10.8659 7.01026 10.8659 7.15146V7.65544C10.8659 7.70492 10.8264 7.74521 10.7779 7.74521H9.9214V5.99917C9.9214 5.85797 9.80928 5.74356 9.67091 5.74356C9.53254 5.74356 9.42042 5.85797 9.42042 5.99917V7.74521H6.06672V5.99917C6.06672 5.85797 5.9546 5.74356 5.81623 5.74356C5.67786 5.74356 5.56574 5.85797 5.56574 5.99917V7.74521H4.70919C4.6607 7.74521 4.62125 7.70492 4.62125 7.65544V5.82004C4.62125 5.06158 5.22597 4.44452 5.96926 4.44452H9.51784C10.2612 4.44452 10.8659 5.06158 10.8659 5.82008V5.95865C10.8659 6.09984 10.978 6.21425 11.1164 6.21425C11.2547 6.21425 11.3669 6.09984 11.3669 5.95865V5.82008C11.3669 4.7797 10.5374 3.93332 9.51784 3.93332H9.13162C9.61373 3.52538 9.92137 2.90982 9.92137 2.22228C9.92137 0.996919 8.94442 0 7.74357 0C6.54272 0 5.56574 0.996919 5.56574 2.22228C5.56574 2.90982 5.87337 3.52538 6.35552 3.93332H5.96926C4.94973 3.93332 4.12027 4.7797 4.12027 5.82004V7.65544C4.12027 7.98684 4.38446 8.25641 4.70919 8.25641H7.49311V9.53443H2.64829C2.28361 9.53443 1.98689 9.8372 1.98689 10.2093V11.2804H0.776388C0.348282 11.2804 0 11.6358 0 12.0727L2.57492e-07 16.6568ZM13.5389 15.742C13.5389 15.587 13.6624 15.461 13.8143 15.461H14.6319L13.5389 16.5763L13.5389 15.742ZM6.06672 2.22228C6.06672 1.27876 6.81893 0.511207 7.74357 0.511207C8.66818 0.511207 9.42039 1.27876 9.42039 2.22228C9.42039 3.16208 8.67229 3.93332 7.74227 3.93332C6.81826 3.9326 6.06672 3.16535 6.06672 2.22228ZM8.0327 16.5763V15.742C8.0327 15.5871 8.15625 15.461 8.30807 15.461H9.12571L8.0327 16.5763ZM9.2046 11.7916C9.35643 11.7916 9.47997 11.9177 9.47997 12.0727V14.9498H8.30807C7.88 14.9498 7.53172 15.3052 7.53172 15.742V16.9378H6.28251C6.13068 16.9378 6.00713 16.8117 6.00713 16.6568V12.0727C6.00713 11.9177 6.13068 11.7916 6.28251 11.7916H9.2046ZM2.52658 16.5763V15.742C2.52658 15.5871 2.65013 15.461 2.80196 15.461H3.61959L2.52658 16.5763ZM0.500982 12.0727C0.500982 11.9177 0.624524 11.7916 0.776388 11.7916H3.69848C3.85031 11.7916 3.97385 11.9177 3.97385 12.0727V14.9498H2.80196C2.37388 14.9498 2.0256 15.3052 2.0256 15.742V16.9378H0.776388C0.624524 16.9378 0.500982 16.8117 0.500982 16.6568L0.500982 12.0727Z" />
                                        </mask>
                                        <path d="M2.57492e-07 16.6568C2.57492e-07 17.0936 0.348283 17.449 0.776388 17.449H2.27609C2.33838 17.449 2.40471 17.4236 2.45324 17.3741L4.40149 15.3861C4.44624 15.3405 4.47483 15.2752 4.47483 15.2054V12.0727C4.47483 11.6358 4.12655 11.2804 3.69848 11.2804H2.48791V10.2093C2.48791 10.1191 2.55985 10.0456 2.64832 10.0456H7.49311V11.2804H6.28254C5.85447 11.2804 5.50619 11.6358 5.50619 12.0726V16.6568C5.50619 17.0936 5.85447 17.449 6.28254 17.449H7.78224C7.84467 17.449 7.9111 17.4234 7.95939 17.3741L9.90764 15.3861C9.95173 15.3411 9.98099 15.2761 9.98099 15.2054V12.0727C9.98099 11.6358 9.6327 11.2804 9.20463 11.2804H7.99409V10.0457H12.8389C12.9273 10.0457 12.9993 10.1191 12.9993 10.2094V11.2805H11.7887C11.3606 11.2805 11.0123 11.6359 11.0123 12.0727V16.6568C11.0123 17.0936 11.3606 17.449 11.7887 17.449H13.2884C13.3527 17.449 13.4179 17.4228 13.4656 17.3741L15.4138 15.3861C15.4592 15.3399 15.4872 15.2739 15.4872 15.2054V14.0573C15.4872 13.9161 15.3751 13.8017 15.2367 13.8017C15.0983 13.8017 14.9862 13.9161 14.9862 14.0573V14.9498H13.8143C13.3862 14.9498 13.0379 15.3052 13.0379 15.742V16.9378H11.7887C11.6369 16.9378 11.5133 16.8117 11.5133 16.6568V12.0727C11.5133 11.9177 11.6369 11.7916 11.7887 11.7916H14.7108C14.8626 11.7916 14.9862 11.9177 14.9862 12.0727V12.8644C14.9862 13.0056 15.0983 13.12 15.2367 13.12C15.3751 13.12 15.4872 13.0056 15.4872 12.8644V12.0727C15.4872 11.6358 15.1389 11.2804 14.7108 11.2804H13.5002V10.2093C13.5002 9.8372 13.2035 9.53443 12.8389 9.53443H7.99406V8.25641H10.7779C11.1027 8.25641 11.3669 7.98684 11.3669 7.65544V7.15146C11.3669 7.01026 11.2548 6.89586 11.1164 6.89586C10.978 6.89586 10.8659 7.01026 10.8659 7.15146V7.65544C10.8659 7.70492 10.8264 7.74521 10.7779 7.74521H9.9214V5.99917C9.9214 5.85797 9.80928 5.74356 9.67091 5.74356C9.53254 5.74356 9.42042 5.85797 9.42042 5.99917V7.74521H6.06672V5.99917C6.06672 5.85797 5.9546 5.74356 5.81623 5.74356C5.67786 5.74356 5.56574 5.85797 5.56574 5.99917V7.74521H4.70919C4.6607 7.74521 4.62125 7.70492 4.62125 7.65544V5.82004C4.62125 5.06158 5.22597 4.44452 5.96926 4.44452H9.51784C10.2612 4.44452 10.8659 5.06158 10.8659 5.82008V5.95865C10.8659 6.09984 10.978 6.21425 11.1164 6.21425C11.2547 6.21425 11.3669 6.09984 11.3669 5.95865V5.82008C11.3669 4.7797 10.5374 3.93332 9.51784 3.93332H9.13162C9.61373 3.52538 9.92137 2.90982 9.92137 2.22228C9.92137 0.996919 8.94442 0 7.74357 0C6.54272 0 5.56574 0.996919 5.56574 2.22228C5.56574 2.90982 5.87337 3.52538 6.35552 3.93332H5.96926C4.94973 3.93332 4.12027 4.7797 4.12027 5.82004V7.65544C4.12027 7.98684 4.38446 8.25641 4.70919 8.25641H7.49311V9.53443H2.64829C2.28361 9.53443 1.98689 9.8372 1.98689 10.2093V11.2804H0.776388C0.348282 11.2804 0 11.6358 0 12.0727L2.57492e-07 16.6568ZM13.5389 15.742C13.5389 15.587 13.6624 15.461 13.8143 15.461H14.6319L13.5389 16.5763L13.5389 15.742ZM6.06672 2.22228C6.06672 1.27876 6.81893 0.511207 7.74357 0.511207C8.66818 0.511207 9.42039 1.27876 9.42039 2.22228C9.42039 3.16208 8.67229 3.93332 7.74227 3.93332C6.81826 3.9326 6.06672 3.16535 6.06672 2.22228ZM8.0327 16.5763V15.742C8.0327 15.5871 8.15625 15.461 8.30807 15.461H9.12571L8.0327 16.5763ZM9.2046 11.7916C9.35643 11.7916 9.47997 11.9177 9.47997 12.0727V14.9498H8.30807C7.88 14.9498 7.53172 15.3052 7.53172 15.742V16.9378H6.28251C6.13068 16.9378 6.00713 16.8117 6.00713 16.6568V12.0727C6.00713 11.9177 6.13068 11.7916 6.28251 11.7916H9.2046ZM2.52658 16.5763V15.742C2.52658 15.5871 2.65013 15.461 2.80196 15.461H3.61959L2.52658 16.5763ZM0.500982 12.0727C0.500982 11.9177 0.624524 11.7916 0.776388 11.7916H3.69848C3.85031 11.7916 3.97385 11.9177 3.97385 12.0727V14.9498H2.80196C2.37388 14.9498 2.0256 15.3052 2.0256 15.742V16.9378H0.776388C0.624524 16.9378 0.500982 16.8117 0.500982 16.6568L0.500982 12.0727Z" fill="#fff" stroke="#fff" stroke-width="2" mask="url(#path-1-inside-1_21822_87689)" />
                                    </svg>
                                    CRM
                                </a>
                            ...
                            <div id="menu-collapse-crm"
                                class="accordion-collapse collapse <?php echo ($currentPage === 'crmaccount' || $currentPage === 'crmcampaigns' || $currentPage === 'crmmeeting' || $currentPage === 'crmtask') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    ...
                                    <a href="#"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 14 14" fill="none">
                                            <path d="M6.75 1.125C6.89918 1.125 7.04226 1.18426 7.14775 1.28975C7.25324 1.39524 7.3125 1.53832 7.3125 1.6875C7.3125 1.83668 7.25324 1.97976 7.14775 2.08525C7.04226 2.19074 6.89918 2.25 6.75 2.25C5.85998 2.25 4.98996 2.51392 4.24993 3.00839C3.50991 3.50285 2.93314 4.20566 2.59254 5.02792C2.25195 5.85019 2.16283 6.75499 2.33647 7.62791C2.5101 8.50082 2.93868 9.30264 3.56802 9.93198C4.19736 10.5613 4.99918 10.9899 5.87209 11.1635C6.74501 11.3372 7.64981 11.2481 8.47208 10.9075C9.29434 10.5669 9.99715 9.99009 10.4916 9.25007C10.9861 8.51004 11.25 7.64002 11.25 6.75C11.25 6.60082 11.3093 6.45774 11.4148 6.35225C11.5202 6.24676 11.6633 6.1875 11.8125 6.1875C11.9617 6.1875 12.1048 6.24676 12.2102 6.35225C12.3157 6.45774 12.375 6.60082 12.375 6.75C12.375 9.85669 9.85669 12.375 6.75 12.375C3.64331 12.375 1.125 9.85669 1.125 6.75C1.125 3.64331 3.64331 1.125 6.75 1.125ZM6.75 3.375C6.89918 3.375 7.04226 3.43426 7.14775 3.53975C7.25324 3.64524 7.3125 3.78832 7.3125 3.9375C7.3125 4.08668 7.25324 4.22976 7.14775 4.33525C7.04226 4.44074 6.89918 4.5 6.75 4.5C6.30499 4.5 5.86998 4.63196 5.49997 4.87919C5.12996 5.12643 4.84157 5.47783 4.67127 5.88896C4.50097 6.3001 4.45642 6.7525 4.54323 7.18895C4.63005 7.62541 4.84434 8.02632 5.15901 8.34099C5.47368 8.65566 5.87459 8.86995 6.31105 8.95677C6.7475 9.04358 7.1999 8.99903 7.61104 8.82873C8.02217 8.65843 8.37357 8.37004 8.62081 8.00003C8.86804 7.63002 9 7.19501 9 6.75C9 6.60082 9.05926 6.45774 9.16475 6.35225C9.27024 6.24676 9.41332 6.1875 9.5625 6.1875C9.71168 6.1875 9.85476 6.24676 9.96025 6.35225C10.0657 6.45774 10.125 6.60082 10.125 6.75C10.125 7.41751 9.92706 8.07003 9.55621 8.62505C9.18536 9.18007 8.65826 9.61265 8.04156 9.86809C7.42486 10.1235 6.74626 10.1904 6.09157 10.0602C5.43688 9.92993 4.83552 9.60849 4.36351 9.13649C3.89151 8.66448 3.57007 8.06312 3.43985 7.40843C3.30962 6.75374 3.37646 6.07514 3.63191 5.45844C3.88735 4.84174 4.31993 4.31464 4.87495 3.94379C5.42997 3.57294 6.08249 3.375 6.75 3.375ZM10.4462 1.18125C10.5208 1.18125 10.5923 1.21088 10.6451 1.26363C10.6978 1.31637 10.7274 1.38791 10.7274 1.4625V2.49187C10.7276 2.56637 10.7573 2.63776 10.81 2.69039C10.8627 2.74301 10.9342 2.77256 11.0087 2.77256H12.0375C12.1121 2.77256 12.1836 2.80219 12.2364 2.85494C12.2891 2.90768 12.3187 2.97922 12.3187 3.05381V3.5685L11.2567 4.6305C11.0458 4.84149 10.7597 4.96006 10.4614 4.96012H9.33637L7.14825 7.14769C7.04216 7.25015 6.90007 7.30685 6.75259 7.30557C6.6051 7.30429 6.46402 7.24513 6.35973 7.14084C6.25543 7.03654 6.19628 6.89546 6.195 6.74798C6.19371 6.60049 6.25041 6.4584 6.35287 6.35231L8.541 4.16475V3.03975C8.54091 2.74149 8.65928 2.4554 8.87006 2.24437L9.93319 1.18125H10.4462Z" fill="#EBEBEB" />
                                        </svg>
                                        Lead
                                    </a>
                                    ...
                                    <a href="#"
                                        class="menu-item <?php echo ($currentPage === '') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path d="M8.2875 11.2125L6.9 12.6C6.6075 12.8925 6.1425 12.8925 5.8425 12.6075C5.76 12.525 5.6775 12.45 5.595 12.3675C4.8225 11.5875 4.125 10.77 3.5025 9.915C2.8875 9.06 2.3925 8.205 2.0325 7.3575C1.68 6.5025 1.5 5.685 1.5 4.905C1.5 4.395 1.59 3.9075 1.77 3.4575C1.95 3 2.235 2.58 2.6325 2.205C3.1125 1.7325 3.6375 1.5 4.1925 1.5C4.4025 1.5 4.6125 1.545 4.8 1.635C4.995 1.725 5.1675 1.86 5.3025 2.055L7.0425 4.5075C7.1775 4.695 7.275 4.8675 7.3425 5.0325C7.41 5.19 7.4475 5.3475 7.4475 5.49C7.4475 5.67 7.395 5.85 7.29 6.0225C7.1925 6.195 7.05 6.375 6.87 6.555L6.3 7.1475C6.2175 7.23 6.18 7.3275 6.18 7.4475C6.18 7.5075 6.1875 7.56 6.2025 7.62C6.225 7.68 6.2475 7.725 6.2625 7.77C6.3975 8.0175 6.63 8.34 6.96 8.73C7.2975 9.12 7.6575 9.5175 8.0475 9.915C8.1225 9.99 8.205 10.065 8.28 10.14C8.58 10.4325 8.5875 10.9125 8.2875 11.2125Z" fill="#FCFCFC" />
                                            <path d="M16.4767 13.7488C16.4767 13.9588 16.4392 14.1763 16.3642 14.3863C16.3417 14.4463 16.3192 14.5063 16.2892 14.5663C16.1617 14.8363 15.9967 15.0913 15.7792 15.3313C15.4117 15.7363 15.0067 16.0288 14.5492 16.2163C14.5417 16.2163 14.5342 16.2237 14.5267 16.2237C14.0842 16.4037 13.6042 16.5013 13.0867 16.5013C12.3217 16.5013 11.5042 16.3213 10.6417 15.9538C9.77922 15.5863 8.91672 15.0913 8.06172 14.4688C7.76922 14.2513 7.47672 14.0338 7.19922 13.8012L9.65172 11.3488C9.86172 11.5063 10.0492 11.6262 10.2067 11.7087C10.2442 11.7237 10.2892 11.7462 10.3417 11.7687C10.4017 11.7912 10.4617 11.7987 10.5292 11.7987C10.6567 11.7987 10.7542 11.7538 10.8367 11.6713L11.4067 11.1088C11.5942 10.9213 11.7742 10.7788 11.9467 10.6888C12.1192 10.5838 12.2917 10.5312 12.4792 10.5312C12.6217 10.5312 12.7717 10.5613 12.9367 10.6288C13.1017 10.6963 13.2742 10.7938 13.4617 10.9213L15.9442 12.6838C16.1392 12.8188 16.2742 12.9762 16.3567 13.1637C16.4317 13.3512 16.4767 13.5388 16.4767 13.7488Z" fill="#FCFCFC" />
                                        </svg>
                                        Contact
                                    </a>
                                    ...
                                    <a href="#"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            ...
                                            <path d="M10.657 2.98813C10.852 3.19063 10.6795 3.49063 10.3945 3.49063H4.522C3.7045 3.49063 2.9395 3.73063 2.302 4.14313C2.0095 4.33063 1.612 4.12813 1.7545 3.80563C2.1745 2.82313 3.157 2.14062 4.2895 2.14062H8.5045C9.3745 2.14062 10.147 2.44813 10.657 2.98813Z" fill="#F2F6FA" />
                                        </svg>
                                        Deals
                                    </a>
                                    ...
                                    <a href="crm-task.php"
                                        class="menu-item <?php echo ($currentPage === 'crmtask') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    ...
                                    <a href="crm-meeting.php"
                                        class="menu-item <?php echo ($currentPage === 'crmmeeting') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path d="M6 1.5V3.75" stroke="#EBEBEB" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12 1.5V3.75" stroke="#EBEBEB" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M2.625 6.82031H15.375" stroke="#EBEBEB" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M16.5 14.25C16.5 14.8125 16.3425 15.345 16.065 15.795C15.5475 16.665 14.595 17.25 13.5 17.25C12.7425 17.25 12.0525 16.9725 11.5275 16.5C11.295 16.305 11.0925 16.065 10.935 15.795C10.6575 15.345 10.5 14.8125 10.5 14.25C10.5 12.5925 11.8425 11.25 13.5 11.25C14.4 11.25 15.2025 11.6475 15.75 12.27C16.215 12.8025 16.5 13.4925 16.5 14.25Z" stroke="#EBEBEB" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.3301 14.2506L13.0726 14.9931L14.6701 13.5156" stroke="#EBEBEB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M15.75 6.375V12.27C15.2025 11.6475 14.4 11.25 13.5 11.25C11.8425 11.25 10.5 12.5925 10.5 14.25C10.5 14.8125 10.6575 15.345 10.935 15.795C11.0925 16.065 11.295 16.305 11.5275 16.5H6C3.375 16.5 2.25 15 2.25 12.75V6.375C2.25 4.125 3.375 2.625 6 2.625H12C14.625 2.625 15.75 4.125 15.75 6.375Z" stroke="#EBEBEB" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M8.99588 10.2734H9.00262" stroke="#EBEBEB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M6.22049 10.2734H6.22723" stroke="#EBEBEB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M6.22049 12.5234H6.22723" stroke="#EBEBEB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        Meeting
                                    </a>
                                    <a href="crm-campaigns.php"
                                        class="menu-item <?php echo ($currentPage === 'crmcampaigns') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 12" fill="none">
                                            <path d="M13.3332 6.33988C13.1415 6.33393 12.9918 6.20433 12.9993 6.05075C13.0067 5.89733 13.1685 5.7776 13.3605 5.78355L16.7655 5.90039C16.9572 5.90635 17.1069 6.03595 17.0995 6.18953C17.092 6.34294 16.93 6.46268 16.7382 6.45673L13.3332 6.33988ZM11.7872 2.32327C11.6456 2.42685 11.4258 2.41903 11.2963 2.30575C11.1671 2.19248 11.1766 2.01662 11.3182 1.91304L13.8326 0.0727707C13.9742 -0.030638 14.1941 -0.0229845 14.3235 0.0902889C14.453 0.203562 14.4432 0.379595 14.3016 0.483004L11.7872 2.32327ZM12.5687 4.35199C12.3878 4.40437 12.1882 4.3297 12.1227 4.18514C12.057 4.0404 12.1506 3.88069 12.3313 3.82831L15.5653 2.88658C15.746 2.83419 15.9457 2.90886 16.0114 3.05359C16.0769 3.19816 15.9835 3.35787 15.8028 3.41025L12.5687 4.35199ZM4.5012 4.96172L5.66051 7.50986C6.55492 7.36529 7.48419 7.31291 8.3871 7.34454C9.5732 7.38638 10.7159 7.57296 11.6754 7.88404L8.80827 1.58189C8.30015 2.34844 7.52905 3.11295 6.59893 3.77592C5.96431 4.22817 5.25381 4.63364 4.5012 4.96172ZM5.31737 7.57007L4.18974 5.09183C4.00669 5.16531 3.82152 5.23385 3.63464 5.29712L4.72698 7.69831C4.9213 7.65086 5.11817 7.608 5.31737 7.57007ZM0.767943 6.14242L1.8522 8.5249L2.73726 8.35108C2.74321 8.35618 2.74895 8.36111 2.77659 8.39802L4.16019 11.42C4.19378 11.4948 4.26309 11.552 4.34685 11.5829C4.43083 11.6146 4.53033 11.6204 4.62366 11.5933L5.62139 11.3026C5.7143 11.2754 5.78552 11.2198 5.82442 11.1531C5.86375 11.0861 5.87098 11.0072 5.83739 10.9331L4.44975 7.85751C4.42955 7.84203 4.4134 7.82349 4.4034 7.80155L3.31128 5.40104L3.1969 5.43523L0.767943 6.14242ZM1.52501 8.62014L0.440964 6.23766L0.394405 6.2511C0.240057 6.29617 0.122064 6.38835 0.0570086 6.49993C-0.00825967 6.6115 -0.0203779 6.74348 0.0357485 6.86713L0.70884 8.34683C0.764967 8.47031 0.880196 8.5647 1.01987 8.61674C1.15934 8.66896 1.32389 8.67865 1.47867 8.63358L1.52501 8.62014ZM9.41396 0.741866C9.33764 0.713632 9.24814 0.707339 9.16373 0.72962L9.14332 0.735403C9.06105 0.761765 8.99791 0.812109 8.96283 0.872997C8.92754 0.933886 8.91967 1.00532 8.94752 1.07301L12.1871 8.19477C12.2177 8.26179 12.2788 8.31383 12.3583 8.34581C12.4414 8.37659 12.5339 8.38254 12.6223 8.35737C12.7105 8.33152 12.7775 8.27948 12.8141 8.21638C12.8506 8.15362 12.8581 8.07963 12.8273 8.01058L9.59 0.894768C9.55811 0.825035 9.49284 0.77129 9.41396 0.741866Z" fill="#F2F6FA" />
                                        </svg>
                                        Campaigns
                                    </a>
                                    <a href="crm-accounts.php"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            ...
                                            <path d="M10.5 6V9.75" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M13.5 6V9.75" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.75 12.75H11.25C10.8375 12.75 10.5 13.0875 10.5 13.5V16.5H13.5V13.5C13.5 13.0875 13.1625 12.75 12.75 12.75Z" stroke="#F2F6FA" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <div class="admin_dash_btns">
                    ...
                    <div class="accordion d-flex flex-column gap-2">
                        <div class="accordion-item">
                            ...
                            <div id="menu-collapse-vehicle"
                                class="accordion-collapse collapse <?php echo ($currentPage === 'vehicleList' || $currentPage === 'vehicleMaintainance' || $currentPage === 'driverlist' || $currentPage === 'fuelManagement' || $currentPage === 'livelocation') ? 'show' : ''; ?>"
                                data-bs-parent="#sidebar-accordion">
                                <div class="accordion-body">
                                    <a href="vehicle-list.php"
                                        class="menu-item  <?php echo ($currentPage === 'vehicleList') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M13.001 14.75H2.00098C1.59098 14.75 1.25098 14.41 1.25098 14V6C1.25098 3.38 3.38098 1.25 6.00098 1.25H15.001C15.411 1.25 15.751 1.59 15.751 2V12C15.751 13.52 14.521 14.75 13.001 14.75ZM2.75098 13.25H13.001C13.691 13.25 14.251 12.69 14.251 12V2.75H6.00098C4.21098 2.75 2.75098 4.21 2.75098 6V13.25Z"
                                    ...
                                    <a href="driver-list.php"
                                        class="menu-item  <?php echo ($currentPage === 'driverlist') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                    ...
                                    <a href="fuel-management.php"
                                        class="menu-item  <?php echo ($currentPage === 'fuelManagement') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M17.5 22.75H3.5C3.09 22.75 2.75 22.41 2.75 22V5C2.75 2.76 4.26 1.25 6.5 1.25H14.5C16.74 1.25 18.25 2.76 18.25 5V22C18.25 22.41 17.91 22.75 17.5 22.75ZM4.25 21.25H16.75V5C16.75 3.59 15.91 2.75 14.5 2.75H6.5C5.09 2.75 4.25 3.59 4.25 5V21.25Z"
                                                fill="#fff" />
                                            <path
                                                d="M19 22.75H2C1.59 22.75 1.25 22.41 1.25 22C1.25 21.59 1.59 21.25 2 21.25H19C19.41 21.25 19.75 21.59 19.75 22C19.75 22.41 19.41 22.75 19 22.75Z"
                                                fill="#fff" />
                                            <path
                                                d="M12.6102 10.75H8.38023C6.75023 10.75 5.74023 9.73999 5.74023 8.10999V6.87999C5.74023 5.24999 6.75023 4.23999 8.38023 4.23999H12.6102C14.2402 4.23999 15.2502 5.24999 15.2502 6.87999V8.10999C15.2502 9.73999 14.2402 10.75 12.6102 10.75ZM8.39023 5.74998C7.58023 5.74998 7.25023 6.07998 7.25023 6.88998V8.11998C7.25023 8.92998 7.58023 9.25998 8.39023 9.25998H12.6202C13.4302 9.25998 13.7602 8.92998 13.7602 8.11998V6.88998C13.7602 6.07998 13.4302 5.74998 12.6202 5.74998H8.39023Z"
                                                fill="#ffff" />
                                            <path
                                                d="M9.5 13.75H6.5C6.09 13.75 5.75 13.41 5.75 13C5.75 12.59 6.09 12.25 6.5 12.25H9.5C9.91 12.25 10.25 12.59 10.25 13C10.25 13.41 9.91 13.75 9.5 13.75Z"
                                                fill="#ffff" />
                                            <path
                                                d="M17.5 16.7599C17.09 16.7599 16.75 16.4299 16.75 16.0099C16.75 15.5999 17.08 15.2599 17.5 15.2599L21.25 15.2499V10.4599L19.66 9.66992C19.29 9.47992 19.14 9.02993 19.32 8.65993C19.51 8.28993 19.96 8.13993 20.33 8.31993L22.33 9.31993C22.58 9.44993 22.74 9.70993 22.74 9.98993V15.9899C22.74 16.3999 22.41 16.7399 21.99 16.7399L17.5 16.7599Z"
                                                fill="#fff" />
                                        </svg>
                                        Fuel
                                    </a>

                                    <a href="vehicle-maintaince.php"
                                        class="menu-item  <?php echo ($currentPage === 'vehicleMaintainance') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="#fff" />
                                            <path
                                                d="M3.99951 8.75H2.99951C2.58951 8.75 2.24951 8.41 2.24951 8C2.24951 7.59 2.58951 7.25 2.99951 7.25H3.99951C4.40951 7.25 4.74951 7.59 4.74951 8C4.74951 8.41 4.40951 8.75 3.99951 8.75Z"
                                                fill="#fff" />
                                            <path
                                                d="M20.9995 8.75H19.9995C19.5895 8.75 19.2495 8.41 19.2495 8C19.2495 7.59 19.5895 7.25 19.9995 7.25H20.9995C21.4095 7.25 21.7495 7.59 21.7495 8C21.7495 8.41 21.4095 8.75 20.9995 8.75Z"
                                                fill="#fff" />
                                            <path
                                                d="M11.9995 5.75C11.5895 5.75 11.2495 5.41 11.2495 5V3C11.2495 2.59 11.5895 2.25 11.9995 2.25C12.4095 2.25 12.7495 2.59 12.7495 3V5C12.7495 5.41 12.4095 5.75 11.9995 5.75Z"
                                                fill="#fff" />
                                            <path
                                                d="M13.4995 5.75H10.4995C10.0895 5.75 9.74951 5.41 9.74951 5C9.74951 4.59 10.0895 4.25 10.4995 4.25H13.4995C13.9095 4.25 14.2495 4.59 14.2495 5C14.2495 5.41 13.9095 5.75 13.4995 5.75Z"
                                                fill="#fff" />
                                            <path
                                                d="M8.99951 15.75H5.99951C5.58951 15.75 5.24951 15.41 5.24951 15C5.24951 14.59 5.58951 14.25 5.99951 14.25H8.99951C9.40951 14.25 9.74951 14.59 9.74951 15C9.74951 15.41 9.40951 15.75 8.99951 15.75Z"
                                                fill="#fff" />
                                            <path
                                                d="M17.9995 15.75H14.9995C14.5895 15.75 14.2495 15.41 14.2495 15C14.2495 14.59 14.5895 14.25 14.9995 14.25H17.9995C18.4095 14.25 18.7495 14.59 18.7495 15C18.7495 15.41 18.4095 15.75 17.9995 15.75Z"
                                                fill="#fff" />
                                        </svg>
                                        Vehicle Maintenance
                                    </a>

                                    <a href="live-location.php"
                                        class="menu-item  <?php echo ($currentPage === 'livelocation') ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
        ...
        <div class="admin_botom_drop_down_container">
            <div class="common_div" id="user_dropdown_btn">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6" fill="none">
                    <path
                        d="M0.672629 4.4349L4.75825 0.522405C4.89444 0.391988 5.02919 0.328222 5.22914 0.33255C5.42909 0.336879 5.56095 0.406415 5.69137 0.542603L9.60387 4.62823C9.8647 4.9006 9.85605 5.30051 9.58367 5.56134C9.3113 5.82218 8.91139 5.81352 8.65056 5.54115L5.19451 1.93218L1.58554 5.38822C1.31317 5.64905 0.913264 5.64039 0.652431 5.36802C0.391597 5.09564 0.400253 4.69574 0.672629 4.4349Z"
                        fill="#FCFCFC" />
                </svg>
            </div>
            <div class="common_div" id="activity_dropdown_btn">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                    <path
                        d="M20.3418 14.25C21.5844 14.25 22.5918 13.2426 22.5918 12C22.5918 10.7574 21.5844 9.75 20.3418 9.75C19.0992 9.75 18.0918 10.7574 18.0918 12C18.0918 13.2426 19.0992 14.25 20.3418 14.25Z"
                        fill="#FCFCFC" />
                    <path
                        d="M20.3418 6.25C21.5844 6.25 22.5918 5.24264 22.5918 4C22.5918 2.75736 21.5844 1.75 20.3418 1.75C19.0992 1.75 18.0918 2.75736 18.0918 4C18.0918 5.24264 19.0992 6.25 20.3418 6.25Z"
                        fill="#F5F5F5" />
                    <path
                        d="M20.3418 22.25C21.5844 22.25 22.5918 21.2426 22.5918 20C22.5918 18.7574 21.5844 17.75 20.3418 17.75C19.0992 17.75 18.0918 18.7574 18.0918 20C18.0918 21.2426 19.0992 22.25 20.3418 22.25Z"
                        fill="#F5F5F5" />
                    <path
                        d="M4.3418 14.25C5.58444 14.25 6.5918 13.2426 6.5918 12C6.5918 10.7574 5.58444 9.75 4.3418 9.75C3.09916 9.75 2.0918 10.7574 2.0918 12C2.0918 13.2426 3.09916 14.25 4.3418 14.25Z"
                        fill="#F5F5F5" />
                    <path
                        d="M19.3418 12.75C19.7518 12.75 20.0918 12.41 20.0918 12C20.0918 11.59 19.7518 11.25 19.3418 11.25H12.0918V7C12.0918 5.42 12.7618 4.75 14.3418 4.75H19.3418C19.7518 4.75 20.0918 4.41 20.0918 4C20.0918 3.59 19.7518 3.25 19.3418 3.25H14.3418C11.9218 3.25 10.5918 4.58 10.5918 7V11.25H5.3418C4.9318 11.25 4.5918 11.59 4.5918 12C4.5918 12.41 4.9318 12.75 5.3418 12.75H10.5918V17C10.5918 19.42 11.9218 20.75 14.3418 20.75H19.3418C19.7518 20.75 20.0918 20.41 20.0918 20C20.0918 19.59 19.7518 19.25 19.3418 19.25H14.3418C12.7618 19.25 12.0918 18.58 12.0918 17V12.75H19.3418Z"
                        fill="#F5F5F5" />
                </svg>
            ...
            <div class="common_popup_bg user_dropdown_wrapper">
                <div class="shape">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="23" viewBox="0 0 25 23" fill="none">
                        <path
                            d="M15.3075 20.6014C14.1676 22.6099 11.2809 22.6311 10.1115 20.6396L0.902639 4.95695C-0.266744 2.9655 1.1582 0.454955 3.46754 0.437966L21.6536 0.30418C23.9629 0.287191 25.4247 2.77651 24.2847 4.78495L15.3075 20.6014Z"
                            fill="white" />
                    </svg>
                </div>
                    ...
                    <a href="user-list.php">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path
                                ...
                                fill="#005399" />
                            <path
                                d="M8.99914 10.875C5.24164 10.875 2.18164 13.395 2.18164 16.5C2.18164 16.71 2.34664 16.875 2.55664 16.875H15.4416C15.6516 16.875 15.8166 16.71 15.8166 16.5C15.8166 13.395 12.7566 10.875 8.99914 10.875Z"
                                fill="#005399" />
                        </svg>
                        Users
                    </a>
            ...
            <div class="common_popup_bg activity_dropdown_wrapper">
                ...
                <div class="links d-flex flex-column gap-2">
                    ...
                    <a href="backup-restore.php">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path
                                d="M15.5318 6.08962V13.1471C15.5318 14.9921 14.0243 16.4996 12.1793 16.4996H5.8193C3.9743 16.4996 2.4668 14.9921 2.4668 13.1471V6.08962C2.4668 4.80712 3.1868 3.68962 4.2443 3.12712C4.6118 2.93212 5.0693 3.19462 5.0693 3.61462C5.0693 4.80712 6.0443 5.78212 7.2368 5.78212H10.7618C11.9543 5.78212 12.9293 4.80712 12.9293 3.61462C12.9293 3.19462 13.3793 2.93212 13.7543 3.12712C14.8118 3.68962 15.5318 4.80712 15.5318 6.08962Z"
                                fill="#005399" />
                            <path
                                d="M10.7628 1.5H7.23781C6.45781 1.5 5.82031 2.13 5.82031 2.91V3.615C5.82031 4.395 6.45031 5.025 7.23031 5.025H10.7628C11.5428 5.025 12.1728 4.395 12.1728 3.615V2.91C12.1803 2.13 11.5428 1.5 10.7628 1.5Z"
                                fill="#005399" />
                        </svg>
                        Backup & Restore
                    </a>
