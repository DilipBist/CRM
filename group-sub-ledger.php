<?php
$pageTitle = 'Group Sub Ledger';
include 'inc/header.php'
?>


<h1 class="text-center">Group Sub Ledger</h1>
                    ...
                    <div class="print-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <tbody>
                                    <?php foreach ($ledgerData as $sub): ?>
                                        <!-- Subledger Header -->
                                        <tr>
                                            <td>
                                                <div class="table_bold_Text">
                                                    <?= htmlspecialchars($sub['subLedger']) ?>
                                                </div>
                                            </td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <?php foreach ($sub['entries'] as $entry): ?>
                                            <tr>
                                                <td><?= htmlspecialchars($entry['ledger']) ?></td>
                                                <td><?= htmlspecialchars($entry['shortName']) ?></td>
                                                <td><?= number_format($entry['openingDebit'], 3) ?></td>
                                                <td><?= number_format($entry['openingCredit'], 3) ?></td>
                                                <td><?= number_format($entry['debitAmount'], 3) ?></td>
                                                <td><?= number_format($entry['creditAmount'], 3) ?></td>
                                                <td><?= number_format($entry['debitBalance'], 3) ?></td>
                                                <td><?= number_format($entry['creditBalance'], 3) ?></td>
                                            </tr>
                                        <?php endforeach; ?>

                                        <!-- Subledger Total -->
                                        <tr class="subledger-total">
                                            <td></td>
                                            <td>
                                                <div class="table_bold_Text">
                                                    Total(no sub legder)
                                            ...
                                            <td>
                                                <div class="table_bold_Text">
                                                    <?= number_format($sub['total']['openingDebit'], 3) ?>
                                                </div>
                                            </td><td>
                                                <div class="table_bold_Text">
                                                    <?= number_format($sub['total']['openingCredit'], 3) ?>
                                                </div>
                                            </td><td>
                                                <div class="table_bold_Text">
                                                    <?= number_format($sub['total']['debitAmount'], 3) ?>
                                                </div>
                                            </td><td>
                                                <div class="table_bold_Text">
                                                    <?= number_format($sub['total']['openingCredit'], 3) ?>
    ...
    <div class="add_asset_filter_bg">
        <div class="ass_filter_popcontent">
            <div class="bg_white">
                ...
                <!-- add asset form  -->
                <div class="asset_filter_form g-form">
                            ...
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-6  col-lg-4 slect-status">
                                    ...
                                    <select class="form-select" aria-label="select" id="group" name="group" required>
                                        ...
                                        <option value="g-ledger">Group by ledger</option>
                                        <option value="sub-ledger-transaction">Sub Ledger Transction Details</option>
                                    </select>
                                </div>
