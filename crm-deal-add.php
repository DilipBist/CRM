                       ...
                       <div class="col-xl-8">
                           <div class="deal_right_view_wrapper">
                               ...
                               <div class="content_div_wrapper mt-4">
                                   ...
                                   <!-- activities  -->
                                   <div class="data active" data-category="activities">
                                   ...
                                   <!-- notes  -->
                                   <div class="data " data-category="note">
                                       <div class="common_wrapper">
                                           <h3>Note </h3>
                                               ...
                                               <div class="d-flex flex-column gap-4">
                                                   <div class="comment_box_wrapper">
                                                       <div class="left_div d-flex align-items-start gap-3 justify-content-between">
                                                           ...
                                                           <div class="three_dot_container position-relative">
                                                               ...
                                                               <div class="dropdown">
                                                                   <div class="change_ledger_btn">Edit</div>
                                                                   <div>Delete</div>
                                                               </div>
                                                           </div>
                                                       </div>
                                   ...
                                   <div class="data" data-category="calls">
                                       <div class="common_wrapper">
                                           ...
                                           <div class="inside_content_container">
                                               ...
                                               <div class="call_box_details_wrapper d-flex flex-column gap-4">
                                                   <div class="call_box_data">
                                                       <div class="top_div d-flex align-items-start justify-content-between gap-2 mb-3">
                                                           <div class="inner d-flex align-items-center gap-2">
                                                               <div class="p">
                                                                   <img src="assets/images/profileimg.jpg" alt="profile">
                                                               </div>
                                                               <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                   <h4>Darlee Robertson</h4>
                                                                   <span> logged a call on 23 Jul 2023, 10:00 pm</span>
                                                               </div>
                                                           </div>

                                                           <div class="d-flex align-items-center gap-3">
                                                               <div class="call_status_select">
                                                                   <div class="slect-status position-relative">
                                                                       <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 15 8" fill="none">
                                                                           <path d="M13.95 0.75L8.51667 6.18333C7.875 6.825 6.825 6.825 6.18333 6.18333L0.75 0.75" stroke="#005399" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                                       </svg>
                                                                       <select class="form-select" aria-label="select" name="call-status" required>
                                                               ...
                                                               <div class="three_dot_container position-relative">
                                                                   ...
                                                                   <div class="dropdown">
                                                                       <div class="edit_call_user_btn">Edit</div>
                                                                       <div>Delete</div>
                                                                   </div>
                                                               </div>
                                                           </div>
                                   ...
                                   <div class="data " data-category="file">
                                       <div class="common_wrapper">
                                           ...
                                           <div class="inside_content_container">
                                               <div class="files_Data_wrapper d-flex flex-column gap-4">
                                                   <div class="files_Details">
                                                       <div class="top-div d-flex justify-content-between gap-2">
                                                           <div>
                                                           ...
                                                           <div class="d-flex align-items-center gap-3 flex-wrap">
                                                               <div class="button_Status">
                                                                   ...
                                                                   <button class="proposal">Proposal</button>
   ...
   <!-- edit note form popup  -->
   <div class="change_ledger_group_popup">
       <div class="outer_layout">
           <div class="change_ledger_group_popup_content">
               <div class="monthly_heading pe-4">
                   Edit Notes

                   <button type="button" id="closeChangeLedger">
                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                           ...
                           <div class="row g-3 align-items-end">
                               ...
                               <div class="col-12">
                                   <div class="form_input d-flex flex-column gap-2">
                                       ...
                                       <input type="text" placeholder="Team meet at Starbucks" id="Title" name="Title">
                                   </div>
                               </div>

                               <div class="form_input d-flex flex-column gap-2">
                                   <label for="note_description">Description <span>*</span></label>
                                   <div class="position-relative editor-wrapper">
                                       <textarea name="note_description" id="note_description" class="editor" placeholder="Write something awesome..."></textarea>
                                       <button id="toggleToolbar" type="button">
                                           <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                               <path fill-rule="evenodd" clip-rule="evenodd" d="M0.777778 1.55556C0.35 1.55556 0 1.20556 0 0.777778C0 0.35 0.35 0 0.777778 0H13.2222C13.65 0 14 0.35 14 0.777778C14 1.20556 13.65 1.55556 13.2222 1.55556H0.777778ZM8.55556 3.11111H0.777778C0.35 3.11111 0 3.46111 0 3.88889C0 4.31667 0.35 4.66667 0.777778 4.66667H8.55556C8.98333 4.66667 9.33333 4.31667 9.33333 3.88889C9.33333 3.46111 8.98333 3.11111 8.55556 3.11111ZM8.55556 9.33333H0.777778C0.35 9.33333 0 9.68333 0 10.1111C0 10.5389 0.35 10.8889 0.777778 10.8889H8.55556C8.98333 10.8889 9.33333 10.5389 9.33333 10.1111C9.33333 9.68333 8.98333 9.33333 8.55556 9.33333ZM13.2222 7.77778H0.777778C0.35 7.77778 0 7.42778 0 7C0 6.57222 0.35 6.22222 0.777778 6.22222H13.2222C13.65 6.22222 14 6.57222 14 7C14 7.42778 13.65 7.77778 13.2222 7.77778ZM0.777778 14H13.2222C13.65 14 14 13.65 14 13.2222C14 12.7944 13.65 12.4444 13.2222 12.4444H0.777778C0.35 12.4444 0 12.7944 0 13.2222C0 13.65 0.35 14 0.777778 14Z" fill="#141414" />
                                           </svg>
                               ...
                               <div class="col-12">
                                   <div class="upload-container">
                                       <div>
                                           <label class="up_label">Attachment <span>*</span></label>
                                           <label class="file-upload" data-upload="AttachmentImage">
                                               ...
                                               <input type="file" name="AttachmentImage" required>
                                               <div class="preview" data-preview="AttachmentImage"></div>
                                           </label>
                                       </div>
                                   </div>
                               </div>
   ...
   <!-- edit call form popup  -->
   <div class="crm_edit_call_popup">
       <div class="outer_layout">
           <div class="crm_edit_call_popup_content">
               <div class="monthly_heading pe-4">
                   Edit Call Logs

                   <button type="button" id="closeCallUser">
                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                           <path d="M9.99935 1.66602C5.40768 1.66602 1.66602 5.40768 1.66602 9.99935C1.66602 14.591 5.40768 18.3327 9.99935 18.3327C14.591 18.3327 18.3327 14.591 18.3327 9.99935C18.3327 5.40768 14.591 1.66602 9.99935 1.66602ZM12.7993 11.916C13.041 12.1577 13.041 12.5577 12.7993 12.7993C12.6743 12.9243 12.516 12.9827 12.3577 12.9827C12.1993 12.9827 12.041 12.9243 11.916 12.7993L9.99935 10.8827L8.08268 12.7993C7.95768 12.9243 7.79935 12.9827 7.64102 12.9827C7.48268 12.9827 7.32435 12.9243 7.19935 12.7993C6.95768 12.5577 6.95768 12.1577 7.19935 11.916L9.11602 9.99935L7.19935 8.08268C6.95768 7.84102 6.95768 7.44102 7.19935 7.19935C7.44102 6.95768 7.84102 6.95768 8.08268 7.19935L9.99935 9.11602L11.916 7.19935C12.1577 6.95768 12.5577 6.95768 12.7993 7.19935C13.041 7.44102 13.041 7.84102 12.7993 8.08268L10.8827 9.99935L12.7993 11.916Z" fill="#FF0000" />
                       </svg>
                   </button>
               ...
               <div class="attendance_form mt-4">
                   <h4>Edit Call Logs </h4>
                   <p>Please kindly complete the form to add new call details.</p>
                   <div class="common_form">
                       <form action="">
                           <div class="row g-3 align-items-end">
                               ...
                               <div class="col-md-12">
                                   <div class="slect-status">
                                       <label for="callStatus" class="mb-2">Status <span class="red">*</span></label>
                                       <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 15 8" fill="none">
                                       ...
                                       <select class="form-select" aria-label="select" id="callStatus" name="callStatus" required>
                               ...
                               <div class="col-md-12">
                                   <div class="form_input d-flex flex-column gap-2 position-relative">
                                       <label for="Date"> Follow Up Date <span class="red">*</span> </label>
                                       <input type="text" class="date-picker" id="Date " name="Date " placeholder="MM/DD/YYYY" required>
                               ...
                               <div class="form_input d-flex flex-column gap-2">
                                   <label for="call_Desc">Note <span>*</span></label>
                                   <div class="position-relative editor-wrapper">
                                       <textarea name="call_Desc" id="call_Desc" class="editor" placeholder="Write something awesome..."></textarea>
                                       <button id="toggleToolbar" type="button">
                                           <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                               <path fill-rule="evenodd" clip-rule="evenodd" d="M0.777778 1.55556C0.35 1.55556 0 1.20556 0 0.777778C0 0.35 0.35 0 0.777778 0H13.2222C13.65 0 14 0.35 14 0.777778C14 1.20556 13.65 1.55556 13.2222 1.55556H0.777778ZM8.55556 3.11111H0.777778C0.35 3.11111 0 3.46111 0 3.88889C0 4.31667 0.35 4.66667 0.777778 4.66667H8.55556C8.98333 4.66667 9.33333 4.31667 9.33333 3.88889C9.33333 3.46111 8.98333 3.11111 8.55556 3.11111ZM8.55556 9.33333H0.777778C0.35 9.33333 0 9.68333 0 10.1111C0 10.5389 0.35 10.8889 0.777778 10.8889H8.55556C8.98333 10.8889 9.33333 10.5389 9.33333 10.1111C9.33333 9.68333 8.98333 9.33333 8.55556 9.33333ZM13.2222 7.77778H0.777778C0.35 7.77778 0 7.42778 0 7C0 6.57222 0.35 6.22222 0.777778 6.22222H13.2222C13.65 6.22222 14 6.57222 14 7C14 7.42778 13.65 7.77778 13.2222 7.77778ZM0.777778 14H13.2222C13.65 14 14 13.65 14 13.2222C14 12.7944 13.65 12.4444 13.2222 12.4444H0.777778C0.35 12.4444 0 12.7944 0 13.2222C0 13.65 0.35 14 0.777778 14Z" fill="#141414" />
                                           </svg>
