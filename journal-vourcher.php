...
<section class="admin_container d-flex">
    ...
    <div class="admin_right_content ms-auto accounting_container">
        ...
        <!-- print table  -->
        <div class="voucher_print_container common_print pl_pr">
            <table>
                <thead>
                    <th colspan="3">Accounting Voucher Creation</th>
                </thead>
                <tbody>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <p><span>By</span> Material Expenses (Tinkune Office Building)</p>
                            <div class="d-flex align-items-center gap-1">Cur Bal: <p>2,51,625 Dr</p>
                            </div>
                        </td>
                        <td>1,00,000</td>
                        <td>1,00,000</td>
                    ...
                    <tr>
                        <td>
                            <p><span>To</span> S.K Furniture & Aluminium</p>
                            <div class="d-flex align-items-center gap-1">Cur Bal: <p>2,51,625 Dr</p>
                            </div>
                        </td>
                    </tr>
