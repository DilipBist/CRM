    ...
    <div class="admin_right_content ms-auto user_list">
        ...
        <div class="admin_list_heading d-flex align-items-center flex-wrap gap-3 justify-content-between outer_padding">
            <div class="left_heading">
                ...
                <p>You can view the Salary list accordingly.</p>
            </div>
    ...
    <div class="outer_layout">
        <div class="attendance_popup_content">
            ...
            <div class="attendance_form mt-4">
                <h4>Add Salary </h4>
                <p>Please kindly complete the form to Add Salary</p>
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-6">
                                <div class="slect-status">
                                    <label for="employee_name" class="mb-2">Employee Name <span class="red">*</span></label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    ...
                                    <select class="form-select" aria-label="select" id="employee_name" name="employee_name" required>
                            ...
                            <div class="col-md-6">
                                <div class="form_input d-flex flex-column gap-2">
                                    <label for="Salary">Net Salary<span>*</span> </label>
                                    <input type="text" id="Salary" name="Salary" placeholder="Enter your Project Name " required>
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="row">
                                    <div class="inner_salary_heading">
                                        <h3>Earning</h3>

                                        <div class="add_earning change_ledger_btn">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                                <path d="M9.99935 18.8307C14.5827 18.8307 18.3327 15.0807 18.3327 10.4974C18.3327 5.91406 14.5827 2.16406 9.99935 2.16406C5.41602 2.16406 1.66602 5.91406 1.66602 10.4974C1.66602 15.0807 5.41602 18.8307 9.99935 18.8307Z" stroke="#00427A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M6.66602 10.5H13.3327" stroke="#00427A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M10 13.8307V7.16406" stroke="#00427A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                            Add New
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form_input d-flex flex-column gap-2">
                                            <label for="fes_bonus">Festival Bonus </label>
                                            <input type="number" id="fes_bonus" name="fes_bonus">
                                        </div>
                                    </div>

                                    <div class="col-md-6 col-lg-4">
                                        <div class="form_input d-flex flex-column gap-2">
                                            <label for="Other">Other<span>*</span> </label>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form_input d-flex flex-column gap-2">
                                            <label for="ded_salary">Basic Salary<span>*</span> </label>
                                            <input type="number" id="ded_salary" name="ded_salary" required>
                                        </div>
                                    </div>

                                    <div class="col-md-6 col-lg-4">
                                        <div class="form_input d-flex flex-column gap-2">
                                            <label for="Fund">Provident Fund </label>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form_input d-flex flex-column gap-2">
                                            <label for="Other2">Other<span>*</span> </label>
                                            <input type="number" id="Other2" name="Other2">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- Add salary pop up ends  -->


<!-- add new salary inner popup  -->
...
<!-- add new salay inner popup ends -->
