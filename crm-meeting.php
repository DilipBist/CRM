     ...
     <div class="admin_right_content ms-auto user_list">
         ...
         <div class="admin_list_heading d-flex align-items-center flex-wrap gap-3 justify-content-between outer_padding">
             <div class="left_heading">
                 <h3>Meeetings List</h3>
                 <p>You can view the Meeetings List accordingly.</p>
             </div>
             ...
             <div class="right_fil_div d-flex align-items-center gap-2 flex-wrap justify-content-md-end">
                 ...
                 <button
                     ...
                     data-heading="Add Meeting Information">
                                     ...
                                     <td>
                                         <div class="table_actions">
                                             <a
                                                 ...
                                                 data-heading="View Meeting Information">
                                                 <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                             ...
                                             <a
                                                 ...
                                                 class="add_acc_groupBtn"
                                                 data-heading="Edit Meeting Information">
                                                 <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
     ...
     <div class="outer_layout">
         <div class="attendance_popup_content">
             <div class="monthly_heading">
                 <span> Add Meeting Information</span>
                         ...
                         <div class="row g-3 align-items-start">
                             ...
                             <div class="col-md-6 col-lg-4">
                                 <div class="slect-status">
                                     <label for="meeting_veneu" class="mb-2">Meeting Venue <span class="red">*</span></label>
                                     ...
                                     <select class="form-select" aria-label="select" id="meeting_veneu " name="meeting_veneu " required>
                             ...
                             <div class="col-md-6 col-lg-4">
                                 <div class="form_input d-flex flex-column gap-2">
                                     ...
                                     <input type="text" id="Host" name="Host" placeholder="Enter a Host Name" required>
                                 </div>
                             </div>
                             ...
                             <div class="col-md-6 col-lg-4">
                                 <div class="form_input d-flex flex-column gap-2 position-relative">
                                     ...
                                     <input
                                         ...
                                         placeholder="6:00 Am">
                                     <svg xmlns="http://www.w3.org/2000/svg" class="calender" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                         <path d="M18.3327 9.9974C18.3327 14.5974 14.5993 18.3307 9.99935 18.3307C5.39935 18.3307 1.66602 14.5974 1.66602 9.9974C1.66602 5.3974 5.39935 1.66406 9.99935 1.66406C14.5993 1.66406 18.3327 5.3974 18.3327 9.9974Z" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                         <path d="M13.0914 12.6495L10.5081 11.1078C10.0581 10.8411 9.69141 10.1995 9.69141 9.67448V6.25781" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                     </svg>
                                 </div>
                             </div>
