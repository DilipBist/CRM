    ...
    <div class="admin_right_content ms-auto">
        ...
        <div class="dashboard_page_container pl_pr mb-5">
            ...
            <div class="top_chart_container">
                ...
                <div class="card first_card">
                    <div class="d-flex align-items-center gap-3 justify-content-between">
                        <div class="card_div">
                            <p class="card-title">Total Cash Balance</p>
                ...
                <div class="card second_payment">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        <div>
                            <p class="card-title">Total Bank Balance</p>
            ...
            <div class="second_chart_container">
                ...
                <!-- ----- monthly chart ------  -->
                <div class="montly_cash_bar_chart">
                    <div class="d-flex gap-2 flex-wrap align-items-center justify-content-between">
                        <h3>Montly cash Transaction</h3>
                        <div class="filter-buttons">
                            <button class="active" onclick="updateChart('all', this)">All</button>
                ...
                <!-- ------ bank withdraw ----- -->
                <div class="bank_width_draw_container">
                    <h3>Bank Withdraw</h3>

                    <div class="bank_progress_bar_container d-flex flex-column gap-3 justify-content-between ">
                        <div class="progress_container">
                            <p>Siddhartha Bank</p>
                            <div class="custom_meter">
                ...
                <div class="bank_width_draw_container">
                    <div class="d-flex align-items-center gap-2 flex-wrap justify-content-between mb-3">
                        <h3 class="m-0">Bank Balance</h3>
                        <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M3 7H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M3 12H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M3 17H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
                            </svg>
                        </div>
                    </div>

                    <div class="bank_balance_table_container c-table">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>SIDDHARTHA BANK (JOINT BANK)</td>
                                        <td>-2.000</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Mahalaxmi Bikas Bank Limited</td>
                                        <td>0.000</td>
                                    </tr>
                                    <tr>
                                        <td>Sanima Bank Limited</td>
            ...
            <div class="third_chart_Table_container">
                <div class="bank_width_draw_container">
                    <div class="d-flex align-items-center gap-2 flex-wrap justify-content-between mb-3">
                        <h3 class="m-0">PDC Status</h3>
                        <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M3 7H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M3 12H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
                ...
                <div class="bg-light-grey">
                    <div class="monthly_purchase_heading mb-3 d-flex align-items-center gap-2 flex-wrap justify-content-between">
                        <h3>Monthly Purchase</h3>
                        <div class="select_box d-flex flex-wrap gap-3">
                            <!-- Date Range Picker -->
                            <div class="position-relative">
                                <input type="text" id="dateRangePicker" placeholder="January, 2023 - December, 2023">
                            ...
                            <!-- Month/Year Picker -->
                            <div class="position-relative">
                                <input type="text" id="monthPicker" placeholder="Month">
                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="7" viewBox="0 0 12 7" fill="none">
                                    <path d="M11 1L6 6L1 1" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                    ...
                    <div class="montly_purchase_tag">
                        <h4>
                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="13" viewBox="0 0 12 13" fill="none">
                                <path d="M12 6.5C12 3.18629 9.31371 0.5 6 0.5C2.68629 0.5 0 3.18629 0 6.5C0 9.81371 2.68629 12.5 6 12.5C9.31371 12.5 12 9.81371 12 6.5Z" fill="#2CAFFE" />
                            </svg>
                            Purchase
                        </h4>
                    </div>
            ...
            <div class="fourth_chart_table_container">
                <div class="bank_width_draw_container">
                    <div class="d-flex align-items-center gap-2 flex-wrap justify-content-between mb-3">
                        <h3 class="m-0">Current Liabilities</h3>
                        <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M3 7H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M3 12H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
                ...
                <div class="status_donut_Chart">
                    ...
                    <div class="char_container d-flex gap-2 flex-wrap">
                        <div class="canvus-container">
                            <h3>Total 222706</h3>
                            <canvas id="statusChart"></canvas>
                        </div>

                        <div class="chart_data d-flex flex-column gap-2">
                            <p>Cash Balance</p>
                            <p>Bank Balance</p>
                            <p>Status</p>
                        </div>
                ...
                <div class="bank_width_draw_container">
                    <div class="d-flex align-items-center gap-2 flex-wrap justify-content-between mb-3">
                        <h3 class="m-0">Petty Cash Fund</h3>
                        <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M3 7H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M3 12H21" stroke="#848484" stroke-width="1.5" stroke-linecap="round" />
