    ...
    <div class="admin_right_content ms-auto user_list">
        ...
        <div class="admin_list_heading d-flex align-items-center flex-wrap gap-3 justify-content-between outer_padding">
            <div class="left_heading">
                <h3>Geo Fences List</h3>
                <p>You can view the Geo Fences list accordingly.</p>
            </div>
            ...
            <div class="right_fil_div d-flex align-items-center gap-2 flex-wrap justify-content-md-end">
                ...
                <a href="add-geo-fence.php" class="">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Assigned To (Workers/Equip.)</th>
                        ...
                        <tbody>
                            <?php foreach ($projectList as $project): ?>
                                <tr>
                                    ...
                                    <td>Main Site A </td>
                                    <td>Circle</td>
                                    <td>Project A – Tower</td>
                                    <td>Hattiban</td>
                                    <td>15 Workers, 2 Vehicles</td>
                                    <td>Always Active</td>
                                    <td>
                                        <!--
                                    ...
                                    <td>
                                        <div class="table_actions">
                                            <a href="add-geo-fence.php" title="View">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            ...
                                            <a href="add-geo-fence.php" aria-label="Edit user List">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
