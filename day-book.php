                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td class="wrap_Text">
                                            <div class="trail_table_heading">Opening</div>
                                        </td>
                                        <td>1,529.00</td>
                                        <td>
                                            -- --
                                    ...
                                    <tr>
                                        <td>2082/04/01</td>
                                        <td>4JV-00072-82/83</td>
                                        <td class="wrap_Text">Sita Dhuwani Sewa </td>
                                        <td>-2.000</td>
                                        <td>-- --</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td class="wrap_Text">TRADE DISCOUNT A/C</td>
                                        <td>-- --</td>
                                        <td>2,7550.00</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td class="wrap_Text">Remarks : Being opening amount supposed to be paid by deducting Rs.19635.40 & will pay Rs. 700000/</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>JV-00084-82/83</td>
                                        <td class="wrap_Text">Suspense A/c</td>
                                        <td>-- --</td>
                                        <td>60,000</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td class="wrap_Text">Wages Payable</td>
                                        <td>15,000.00</td>
                                        <td>-- --</td>
                                    </tr>
                        ...
                        <div class="table-responsive w-100">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="3">JV-00072-82/83</td>
                                        <td>CASH A/C</td>
                                        <td>-2.000</td>
                                        <td>-- --</td>
                                    </tr>
