            ...
            <div class="top_chart_container">
                ...
                <a href="#" class="card second_payment">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        <div>
                            <p class="card-title">Total Quotation</p>
                            <h2 class="card-value">Rs 50,00,000</h2>
                        </div>
                ...
                <div class="card first_card">
                    <div class="d-flex align-items-center gap-3 justify-content-between">
                        <div class="card_div">
                            <p class="card-title">Outstanding Quotation</p>
                            <span>Your Total Balance is</span>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <h4 class="card-value">100</h4>
                ...
                <div class="card payment_card second_payment">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        <div>
                            <p class="card-title">Ordered Quotation </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table_actions">
                                                <a href="add-purchase-entries-requisation.php" title="View">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                ...
                                                <a href="add-purchase-entries-requisation.php" title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
